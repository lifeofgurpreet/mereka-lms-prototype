...
echo "    2. First launch local platform:"
echo "         tutor local launch -I --skip-build"
echo "         make tutor-start"
echo "         ./scripts/infra/verify-local-bootstrap-readiness.sh"
echo "    3. Daily start after first launch:"
echo "         make tutor-start"
echo "    4. Access:"
...
echo ""
echo "  See docs/guides/onboarding/DEVCONTAINER_GUIDE.md for full instructions."
echo "----------------------------------------------------------------------"
