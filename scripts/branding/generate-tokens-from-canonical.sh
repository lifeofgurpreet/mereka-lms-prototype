...
def build_scss_generated_block() -> str:
    ...
    lines.append(f"  --pgn-typography-font-size-sm: {token_or_default('--pgn-typography-font-size-sm', token_or_default('--pgn-font-size-sm', '0.875rem'))};\n")
    lines.append(f"  --pgn-typography-font-size-base: {token_or_default('--pgn-typography-font-size-base', token_or_default('--pgn-font-size-base', '1rem'))};\n")
    lines.append(f"  --pgn-typography-font-size-lg: {token_or_default('--pgn-typography-font-size-lg', token_or_default('--pgn-font-size-lg', '1.125rem'))};\n")
    lines.append(f"  --pgn-typography-line-height-sm: {token_or_default('--pgn-typography-line-height-sm', token_or_default('--pgn-line-height-sm', '1.5'))};\n")
    lines.append(f"  --pgn-typography-line-height-base: {token_or_default('--pgn-typography-line-height-base', token_or_default('--pgn-line-height-base', '1.5'))};\n")
    lines.append(f"  --pgn-typography-line-height-lg: {token_or_default('--pgn-typography-line-height-lg', token_or_default('--pgn-line-height-lg', '1.5'))};\n")
    ...
    lines.append(f"  --pgn-size-border-radius-sm: {token_or_default('--pgn-size-border-radius-sm', token_or_default('--pgn-border-radius-sm', token_or_default('--radius-sm', '0.25rem')))};\n")
    lines.append(f"  --pgn-size-border-radius-base: {token_or_default('--pgn-size-border-radius-base', token_or_default('--pgn-border-radius', token_or_default('--radius-md', '0.375rem')))};\n")
    lines.append(f"  --pgn-size-border-radius-lg: {token_or_default('--pgn-size-border-radius-lg', token_or_default('--pgn-border-radius-lg', token_or_default('--radius-lg', '0.425rem')))};\n")
...
def build_overrides_root_block() -> str:
    ...
    lines.append("  --pgn-spacing-spacer-5: 3rem;\n")
    lines.append("  --pgn-spacing-spacer-6: 4.5rem;\n")
    lines.append(f"  --pgn-size-border-radius-sm: {token_or_default('--pgn-size-border-radius-sm', token_or_default('--pgn-border-radius-sm', '0.25rem'))};\n")
    lines.append(f"  --pgn-size-border-radius-base: {token_or_default('--pgn-size-border-radius-base', token_or_default('--pgn-border-radius', '0.375rem'))};\n")
    lines.append(f"  --pgn-size-border-radius-lg: {token_or_default('--pgn-size-border-radius-lg', token_or_default('--pgn-border-radius-lg', '0.425rem'))};\n")
