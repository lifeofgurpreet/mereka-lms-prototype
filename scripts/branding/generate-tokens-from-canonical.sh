...
def build_scss_generated_block() -> str:
    ...
    lines.append("  --mereka-mfe-card-shadow: 0 25px 60px rgba(26, 22, 35, 0.08);\n")
    lines.append("  --mereka-mfe-surface: var(--pgn-color-white);\n")
    lines.append("  --mereka-mfe-surface-muted: rgba(26, 22, 35, 0.04);\n")
    lines.append("  --mereka-mfe-border: rgba(26, 22, 35, 0.10);\n")
    ...
    lines.append("  --mereka-mfe-focus: rgba(35, 112, 114, 0.18);\n")
    ...
    lines.append(f"  --mereka-mfe-btn-shadow: {token_or_default('--mereka-mfe-btn-shadow', '0 12px 30px rgb(var(--mereka-color-blue-rgb) / 0.3)')};\n")
    ...
    lines.append("  --mereka-mfe-dropdown-shadow: 0 20px 60px rgba(26, 22, 35, 0.14);\n")
