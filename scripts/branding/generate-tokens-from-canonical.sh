...
def build_scss_generated_block() -> str:
    ...
    lines.append("  --mereka-blue: #{$color-blue};\n")
    ...
    lines.append("  --mereka-black: #{$color-black};\n")
    ...
    # Paragon bridge
    lines.append("  --pgn-color-primary: #{$color-magenta};\n")
    lines.append("  --pgn-color-secondary: #{$color-teal};\n")
    lines.append("  --pgn-color-success: #{$color-success};\n")
    lines.append("  --pgn-color-info: #{$color-info};\n")
    lines.append("  --pgn-color-warning: #{$color-warning};\n")
    lines.append("  --pgn-color-danger: #{$color-danger};\n")
    ...
    lines.append("  --pgn-font-family-sans-serif: #{$mereka-body-font};\n")
    lines.append("  --pgn-heading-font-family: #{$mereka-heading-font};\n")
    ...
    lines.append(f"  --pgn-font-size-sm: {token_or_default('--pgn-font-size-sm', '0.875rem')};\n")
    lines.append(f"  --pgn-font-size-base: {token_or_default('--pgn-font-size-base', '1rem')};\n")
    lines.append(f"  --pgn-font-size-lg: {token_or_default('--pgn-font-size-lg', '1.125rem')};\n")
    lines.append(f"  --pgn-line-height-sm: {token_or_default('--pgn-line-height-sm', '1.5')};\n")
    lines.append(f"  --pgn-line-height-base: {token_or_default('--pgn-line-height-base', '1.5')};\n")
    lines.append(f"  --pgn-line-height-lg: {token_or_default('--pgn-line-height-lg', '1.5')};\n")
    lines.append("  --pgn-typography-font-family-sans-serif: var(--pgn-font-family-sans-serif);\n")
    lines.append("  --pgn-typography-font-family-base: var(--pgn-font-family-sans-serif);\n")
    lines.append("  --pgn-typography-font-size-sm: var(--pgn-font-size-sm);\n")
    lines.append("  --pgn-typography-font-size-base: var(--pgn-font-size-base);\n")
    lines.append("  --pgn-typography-font-size-lg: var(--pgn-font-size-lg);\n")
    lines.append("  --pgn-typography-line-height-sm: var(--pgn-line-height-sm);\n")
    lines.append("  --pgn-typography-line-height-base: var(--pgn-line-height-base);\n")
    lines.append("  --pgn-typography-line-height-lg: var(--pgn-line-height-lg);\n")
    ...
    lines.append(f"  --pgn-border-radius-sm: {token_or_default('--pgn-border-radius-sm', token_or_default('--radius-sm', '0.25rem'))};\n")
    lines.append(f"  --pgn-border-radius: {token_or_default('--pgn-border-radius', token_or_default('--radius-md', '0.375rem'))};\n")
    lines.append(f"  --pgn-border-radius-lg: {token_or_default('--pgn-border-radius-lg', token_or_default('--radius-lg', '0.425rem'))};\n")
    lines.append("  --pgn-size-border-radius-sm: var(--pgn-border-radius-sm);\n")
    lines.append("  --pgn-size-border-radius-base: var(--pgn-border-radius);\n")
    lines.append("  --pgn-size-border-radius-lg: var(--pgn-border-radius-lg);\n")
...
def build_overrides_root_block() -> str:
    ...
    lines.append("  );\n")
    lines.append("\n")
    lines.append("  /* Legacy compatibility (older overrides used these names) */\n")
    lines.append("  --mereka-teal: var(--mereka-color-teal);\n")
    lines.append("  --mereka-magenta: var(--mereka-color-magenta);\n")
    lines.append("  --mereka-blue: var(--mereka-color-blue);\n")
    lines.append("  --mereka-black: var(--mereka-color-ink-900);\n")
    lines.append("\n")
    lines.append("  /* Paragon bridge (MFEs) */\n")
    lines.append("  --pgn-color-primary: var(--mereka-color-magenta);\n")
    lines.append("  --pgn-color-secondary: var(--mereka-color-teal);\n")
    lines.append("  --pgn-color-success: var(--mereka-color-success);\n")
    lines.append("  --pgn-color-info: var(--mereka-color-info);\n")
    lines.append("  --pgn-color-warning: var(--mereka-color-warning);\n")
    lines.append("  --pgn-color-danger: var(--mereka-color-danger);\n")
    ...
    lines.append("  --pgn-font-family-sans-serif: var(--mereka-font-body);\n")
    lines.append("  --pgn-heading-font-family: var(--mereka-font-heading);\n")
    ...
    lines.append("  --pgn-spacing-spacer-5: 3rem;\n")
    lines.append("  --pgn-spacing-spacer-6: 4.5rem;\n")
    lines.append("  --pgn-border-radius-sm: 0.25rem;\n")
    lines.append("  --pgn-border-radius: 0.375rem;\n")
    lines.append("  --pgn-border-radius-lg: 0.425rem;\n")
    lines.append("  --pgn-size-border-radius-sm: var(--pgn-border-radius-sm);\n")
    lines.append("  --pgn-size-border-radius-base: var(--pgn-border-radius);\n")
    lines.append("  --pgn-size-border-radius-lg: var(--pgn-border-radius-lg);\n")
