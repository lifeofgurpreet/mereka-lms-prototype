...
def build_scss_generated_block() -> str:
    ...
    lines.append("  --mereka-color-indigo-rgb: 39 110 241;\n")
    lines.append("  --mereka-color-teal-rgb: 45 137 139;\n")
    ...
    lines.append("  --pgn-color-primary-400: #{$color-magenta};\n")
    lines.append("  --pgn-color-primary-500: #{$color-magenta};\n")
