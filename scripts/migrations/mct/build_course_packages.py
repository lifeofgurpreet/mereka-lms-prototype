...
python scripts/migrations/mct/scripts/build_course_packages.py \
  --course-structure scripts/migrations/mct/output/course_structure.json \
  --courses-csv scripts/migrations/mct/output/courses.csv \
  --output-dir scripts/migrations/mct/output/course_packages \
  --org SKILLOURFUTURE \
  --course-prefix MCT- \
  --run-prefix RUN- \
  --language en
