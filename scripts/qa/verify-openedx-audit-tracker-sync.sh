...
elif [[ -f "$REPO_ROOT/docs/concepts/architecture/OPENEDX_REPO_ARCH_HYGIENE_AUDIT_TRACKER.md" ]]; then
...
elif [[ -f "$REPO_ROOT/docs/concepts/architecture/OPENEDX_REPO_AUDIT_EXECUTION_BOARD.md" ]]; then
