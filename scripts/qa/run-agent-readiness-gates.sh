...
echo "-> python3 tools/knowledge/build_agent_task_bundles.py --check --repo-root . --range ${RANGE}"
python3 tools/knowledge/build_agent_task_bundles.py --check --repo-root . --range "${RANGE}"
