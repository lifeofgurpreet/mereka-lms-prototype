...
AUDIT_DOC="$REPO_ROOT/docs/architecture/LEGACY_COURSEWARE_AUDIT.md"

echo -e "${BLUE}=== Legacy Courseware Migration Audit ===${NC}"
echo "  Checks Tutor Ulmo (v21) Learning MFE wiring"
echo "  Reference: docs/architecture/LEGACY_COURSEWARE_AUDIT.md"
echo ""
...
if [[ -f "$AUDIT_DOC" ]]; then
  pass "Legacy courseware audit document present at docs/architecture/LEGACY_COURSEWARE_AUDIT.md"
else
