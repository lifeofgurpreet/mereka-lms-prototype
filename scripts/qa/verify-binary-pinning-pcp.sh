...
#
# This is the companion script to docs/operations/BINARY_PINNING.md (T057).
...
echo -e "      Policy: docs/operations/BINARY_PINNING.md"
echo
...
if [[ ${FAIL} -gt 0 ]]; then
  ...
  echo -e "  See docs/operations/BINARY_PINNING.md for the pinning process."
  exit 1
else
