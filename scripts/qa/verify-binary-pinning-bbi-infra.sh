...
#
# Cross-repo reference: docs/operations/BINARY_PINNING.md
# Task: T057 / DR2:I-015
...
echo "    Policy doc:   docs/operations/BINARY_PINNING.md"
echo ""
...
POLICY_DOC="${REPO_ROOT}/docs/operations/BINARY_PINNING.md"
if [[ -f "$POLICY_DOC" ]]; then
  pass "Binary pinning policy documented at docs/operations/BINARY_PINNING.md"
else
  fail "Binary pinning policy doc missing: docs/operations/BINARY_PINNING.md"
fi
...
if [[ "$TOTAL_VIOLATIONS" -gt 0 ]]; then
  echo ""
  echo "  Fix: See docs/operations/BINARY_PINNING.md for pinning patterns."
