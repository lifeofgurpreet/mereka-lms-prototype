...
require_contains "docs/guides/onboarding/QUICK_START_LOCAL.md" 'Current-main bootstrap rerun' "quick start separates current-main bootstrap rerun state"
require_contains "docs/guides/onboarding/QUICK_START_LOCAL.md" 'initialized-state proof only' "quick start states current bootstrap proof limits"
