...
require_contains "docs/guides/onboarding/README.md" 'Current-main bootstrap rerun' "onboarding index separates current-main bootstrap rerun state"
require_contains "docs/guides/onboarding/README.md" 'initialized-state proof, not MFE authn route or branded theme asset proof' "onboarding index states current bootstrap proof limits"
require_contains "docs/guides/onboarding/README.md" 'Known coverage gaps from the green rerun' "onboarding index does not hide current bootstrap coverage gaps"
...
require_contains "docs/guides/onboarding/QUICK_START_LOCAL.md" 'Current-head Bootstrap Local Readiness' "quick start separates current-head bootstrap rerun state"
require_contains "docs/guides/onboarding/QUICK_START_LOCAL.md" 'Not closed until readiness/provenance steps complete' "quick start states current bootstrap proof limits"
...
require_contains "docs/guides/onboarding/QUICK_START_LOCAL.md" 'Current-head Bootstrap Local Readiness' "quick start keeps current-head bootstrap proof state explicit"
