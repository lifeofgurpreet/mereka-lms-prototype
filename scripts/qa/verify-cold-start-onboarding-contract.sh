...
require_contains "docs/guides/onboarding/AGENT_SETUP_CHECKLIST.md" '2026-04-22' "agent setup checklist carries current verification date"
...
require_contains "docs/guides/onboarding/AGENT_SETUP_CHECKLIST.md" 'prepare-tutor-build-context\.sh --target all' "agent setup checklist manual build path prepares build context"
require_contains "docs/guides/onboarding/AGENT_SETUP_CHECKLIST.md" 'ensure-buildx-dependency-mirror\.sh' "agent setup checklist manual build path selects BuildKit dependency mirror"
require_contains "docs/guides/onboarding/AGENT_SETUP_CHECKLIST.md" 'LOCAL_ADMIN_PASSWORD="\$LOCAL_ADMIN_PASSWORD"' "agent setup checklist passes local admin password into docker exec"
...
require_contains "docs/guides/onboarding/DEVCONTAINER_GUIDE.md" 'verify-local-bootstrap-readiness\.sh' "devcontainer guide verifies readiness after first launch"
...
require_contains "docs/reference/contracts/DEVELOPER_ENVIRONMENT_PROOF_MATRIX.md" '2026-04-22' "developer environment matrix carries current verification date"
...
require_contains "docs/ops/quickref/tutor-commands.md" '\./scripts/infra/tutor-config-save\.sh --set OPENEDX_COMMON_VERSION=open-release/ulmo\.1' "Tutor quickref uses current governed Open edX source ref example"
