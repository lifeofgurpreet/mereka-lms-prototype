...
require_contains "docs/guides/onboarding/README.md" 'runner failure' "onboarding index does not hide current runner-blocked bootstrap proof"
...
require_contains "docs/guides/onboarding/QUICK_START_LOCAL.md" 'runner failure' "quick start does not hide current runner-blocked bootstrap proof"
