...
CONTRAST_DOC="$REPO_ROOT/docs/runbooks/operations/A11Y_CONTRAST_FOCUS_GATE.md"
GATE_DOC="$REPO_ROOT/docs/runbooks/operations/A11Y_TENANT_BRANDING_GATE.md"
...
if [[ "$FAIL" -eq 0 ]]; then
  ...
  if [[ "$WARN" -gt 0 ]]; then
    ...
    echo "  - See docs/runbooks/operations/A11Y_TENANT_BRANDING_GATE.md for full requirements"
  ...
  echo "See docs/runbooks/operations/A11Y_TENANT_BRANDING_GATE.md for requirements and remediation."
  echo ""
