...
file_exists "docs/ops/runbooks/TROUBLESHOOTING.md"
file_exists "docs/reference/operations/MONITORING.md"
file_exists "docs/ops/runbooks/OBSERVABILITY_QUICKSTART.md"
file_exists "docs/ops/runbooks/ONCALL_OBSERVABILITY_PLAYBOOK.md"
file_exists "docs/policies/operations/ONCALL_ROTATION.md"
file_exists "docs/ops/runbooks/INCIDENT_RESPONSE.md"
file_exists "docs/ops/runbooks/INCIDENT_TEMPLATES.md"
file_exists "docs/reference/operations/ALERT_SEVERITY_MATRIX.md"
file_exists "docs/ops/runbooks/ALERT_TUNING_SOP.md"
file_exists "docs/policies/operations/SLO_POLICY.md"
file_exists "docs/ops/runbooks/SLO_DASHBOARDS_SETUP.md"
