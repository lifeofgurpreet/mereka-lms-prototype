...
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-badge-row" "LMS discovery partial styles course card badge row"
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-badge" "LMS discovery partial styles course card badges"
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-visual-copy" "LMS discovery partial styles discovery card visual copy"
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-meta" "LMS discovery partial styles course card meta row"
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-guidance" "LMS discovery partial styles the course guidance copy"
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-decision-grid" "LMS discovery partial styles the course decision grid"
check_contains "$LMS_DISCOVERY_SCSS" ".find-courses .course .course-signal" "LMS discovery partial styles the course signal cards"
...
check_contains "$COURSE_TEMPLATE_LMS" "class=\"course-visual-copy\"" "LMS course card template includes visual decision-support copy"
...
check_contains "$COURSE_CARD_TEMPLATE_LMS" "class=\"course-visual-copy\"" "Discovery template includes visual decision-support copy"
