...
# Key paths
PLAN_DOC="$REPO_ROOT/docs/operations/RKE2_MIGRATION_PLAN.md"
HANDOFF_DOC="$REPO_ROOT/docs/operations/RKE2_LMS_HANDOFF.md"
ROLLOUT_MATRIX="$REPO_ROOT/docs/operations/RKE2_ROLLOUT_MATRIX.md"
...
if [[ "$FAIL" -gt 0 ]]; then
  ...
  echo "  Migration plan:  docs/operations/RKE2_MIGRATION_PLAN.md"
  echo "  Handoff doc:     docs/operations/RKE2_LMS_HANDOFF.md"
  echo "  Rollout matrix:  docs/operations/RKE2_ROLLOUT_MATRIX.md"
