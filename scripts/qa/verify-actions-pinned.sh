...
#
# See docs/operations/ALLOWED_ACTIONS_POLICY.md for the full policy.
...
echo -e "      Policy: docs/operations/ALLOWED_ACTIONS_POLICY.md"
...
if [[ ${violations} -gt 0 ]]; then
  ...
  echo -e "  See docs/operations/ALLOWED_ACTIONS_POLICY.md for the process."
  exit 1
else
