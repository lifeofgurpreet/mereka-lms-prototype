...
TENANT_FOOTER_LANE_DOC="$REPO_ROOT/docs/ops/runbooks/TENANT_FOOTER_VARIANT_LANE.md"
...
if [[ "$FAIL" -gt 0 ]]; then
  ...
  echo "  - AC-TF-002: Document variant selection chain in docs/ops/runbooks/TENANT_FOOTER_VARIANT_LANE.md"
