...
FOOTER_MATRIX_DOC="$REPO_ROOT/docs/reference/operations/FOOTER_VARIANT_MATRIX.md"
TENANT_FOOTER_LANE_DOC="$REPO_ROOT/docs/runbooks/operations/TENANT_FOOTER_VARIANT_LANE.md"
...
if [[ "$FAIL" -gt 0 ]]; then
  ...
  echo "  - AC-TF-002: Document variant selection chain in docs/runbooks/operations/TENANT_FOOTER_VARIANT_LANE.md"
