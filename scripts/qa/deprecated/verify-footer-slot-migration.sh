...
CONTRACT_DOC="${REPO_ROOT}/docs/ops/runbooks/architecture/FOOTER_SLOT_MIGRATION.md"
...
if [[ -f "${CONTRACT_DOC}" ]]; then
    do_pass "Contract document exists at docs/ops/runbooks/architecture/FOOTER_SLOT_MIGRATION.md"
else
    do_fail "Contract document missing: docs/ops/runbooks/architecture/FOOTER_SLOT_MIGRATION.md"
fi
