...
#
# Verifies that docs/reference/architecture/MFE_VERSIONS.md (canonical source of truth)
...
MFE_VERSIONS_DOC="$REPO_ROOT/docs/reference/architecture/MFE_VERSIONS.md"
...
if [ ! -f "$MFE_VERSIONS_DOC" ]; then
  do_fail "MFE_VERSIONS.md not found at docs/reference/architecture/MFE_VERSIONS.md"
  echo ""
