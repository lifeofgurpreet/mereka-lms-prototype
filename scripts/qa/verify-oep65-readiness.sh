...
PATCHES_INVENTORY_DOC="$REPO_ROOT/docs/architecture/TUTOR_PATCHES_INVENTORY.md"
...
if [[ "$FAIL" -gt 0 ]]; then
  ...
  echo "See docs/architecture/OEP65_MODULE_READINESS.md for remediation guidance."
  exit 1
fi
