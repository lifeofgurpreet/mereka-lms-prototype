...
DOC_REL = Path("docs/reference/architecture/PARAGON_V22_TOKEN_AUDIT.md")
FULL_MISSING_REL = Path("docs/reference/architecture/PARAGON_V22_TOKEN_AUDIT_CONSUMED_MISSING.tsv")
DEFINED_ONLY_REL = Path("docs/reference/architecture/PARAGON_V22_TOKEN_AUDIT_DEFINED_IGNORED.tsv")
CONSUMED_DEFINED_REL = Path("docs/reference/architecture/PARAGON_V22_TOKEN_AUDIT_CONSUMED_DEFINED.tsv")
