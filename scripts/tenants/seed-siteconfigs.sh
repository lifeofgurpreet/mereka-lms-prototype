...
site_values = {
    ...
    "MFE_CONFIG": {
        ...
        "FAVICON_URL": f"{lms_url}/theming/asset/{theme}/images/favicon.ico",
        "LOGO_URL": f"{lms_url}/theming/asset/{theme}/images/logo-horizontal.png",
        "LOGO_WHITE_URL": f"{lms_url}/theming/asset/{theme}/images/logo-horizontal-white.png",
        "LOGO_TRADEMARK_URL": f"{lms_url}/theming/asset/{theme}/images/logo.png",
