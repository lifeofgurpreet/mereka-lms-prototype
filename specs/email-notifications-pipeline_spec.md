...
- Mobile app users (iOS, already in TestFlight; Android, in development per `specs/proposals/mobile-apps-enterprise_spec.md`) have no push notification support
...
- In scope:
  ...
  - Device token registration and lifecycle (coordinates with `specs/proposals/mobile-apps-enterprise_spec.md`)
...
- Out of scope:
  ...
  - Mobile app UI implementation for notification tray (covered by `specs/proposals/mobile-apps-enterprise_spec.md`)
  - Push notification payload format and deep linking (defined in `specs/proposals/mobile-apps-enterprise_spec.md`)
...
- The Firebase project `mereka-academy` exists per `specs/proposals/mobile-apps-enterprise_spec.md` assumptions, configured for both iOS and Android
...
- The device registration API MUST be as specified in `specs/proposals/mobile-apps-enterprise_spec.md`:
...
2. **Firebase project readiness**: The `specs/proposals/mobile-apps-enterprise_spec.md` assumes a Firebase project `mereka-academy` exists. Has the Firebase project been created? Is the FCM API enabled? Is there a service account key generated? This is a prerequisite for push notification dispatch.
...
6. **Push notification provider preference**: The spec aligns with `specs/proposals/mobile-apps-enterprise_spec.md` in using FCM for both platforms. Should the backend also integrate directly with APNs for iOS (bypassing FCM) for lower latency and higher reliability, or is FCM-only acceptable for v1?
