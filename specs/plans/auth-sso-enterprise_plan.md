...
- [ ] **[S]** T-092: Update `docs/policies/operations/AUTH_HARDENING_SPEC.md` to reference this spec as the authoritative contract| AC: Docs | Depends: None
- [ ] **[S]** T-093: Update `docs/ops/runbooks/TROUBLESHOOTING.md` with enterprise SSO troubleshooting section | AC: Docs |Depends: T-091
