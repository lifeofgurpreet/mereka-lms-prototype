...
| Domain add/remove <30min | Documented procedure timed | manual_verification | `docs/operations/DOMAIN_MANAGEMENT.md` | Document with step timings |
...
**Steps**:
1. Follow `docs/operations/DOMAIN_MANAGEMENT.md` to add a test domain
2. Time each step
