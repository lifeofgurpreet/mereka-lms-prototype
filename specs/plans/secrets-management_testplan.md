...
| EC-7: Concurrent secret updates | No automated test (coordination via rotation checklist) | `manual_verification` | `docs/ops/runbooks/SECRET_ROTATION_CHECKLIST.md` | P3 |
