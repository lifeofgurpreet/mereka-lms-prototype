...
| AC-017 | Happy: Secret rotation completes within 1 hour following DR-006 checklist | manual_verification | Follow `docs/operations/SECRET_ROTATION_CHECKLIST.md` | Infisical + GCP SM access |
