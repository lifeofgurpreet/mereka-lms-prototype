...
- [ ] **[M] Task D.1**: Update observability documentation |AC: N/A | Depends: Phase 1-5
  ...
  - **Files**:
    ...
    - `docs/ops/runbooks/OBSERVABILITY_QUICKSTART.md` (modify:update access instructions)
    - `docs/ops/runbooks/TROUBLESHOOTING.md` (modify: add observability troubleshooting section)
