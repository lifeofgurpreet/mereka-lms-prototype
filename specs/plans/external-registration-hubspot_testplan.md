...
| EC-11: Concurrent Secret Updates | No automated test; covered by rotation checklist coordination | `manual_verification` | `docs/operations/SECRET_ROTATION_CHECKLIST.md` | P3 |
