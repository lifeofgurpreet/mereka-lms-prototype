...
- [ ] **[M]** Write domain addition/removal runbook (`docs/operations/DOMAIN_MANAGEMENT.md`) | Depends: All build tasks
  ...
  - **Files**: `docs/operations/DOMAIN_MANAGEMENT.md` (new)

- [ ] **[S]** Update `docs/operations/OPENEDX_HOSTNAMES.md` with current domain inventory | Depends: None
  ...
  - **Files**: `docs/operations/OPENEDX_HOSTNAMES.md`

- [ ] **[S]** Update `docs/operations/TROUBLESHOOTING.md` with multisite edge cases | Depends: None
...
- [ ] **[S]** Document rollback procedure in domain management runbook | Depends: Docs task
  - **Done**: Already included in the spec. Copy to `docs/operations/DOMAIN_MANAGEMENT.md` with concrete commands.
  - **Files**: `docs/operations/DOMAIN_MANAGEMENT.md`
