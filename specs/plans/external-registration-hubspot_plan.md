...
- [ ] **[S]** Add HubSpot registration troubleshooting section to `docs/ops/runbooks/TROUBLESHOOTING.md`: common errors, how to check logs, how to verify ExternalSecrets, how to test signature verification
