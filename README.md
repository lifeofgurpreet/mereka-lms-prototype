<!--
This repo is the Mereka LMS fork — combines:
  • the Open edX backend (mirrored from Biji-Biji-Initiative/mereka-lms)
  • the Mereka UX prototype at docs/design-reference/mereka-ux-prototype/
See INTEGRATION_NOTES.md for the fork relationship and upstream sync strategy.
-->
