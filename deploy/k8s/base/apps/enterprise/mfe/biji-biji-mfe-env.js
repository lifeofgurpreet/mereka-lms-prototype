// Runtime configuration for Biji-Biji Enterprise MFEs
...
// PARAGON_THEME: points MFE shell to Biji-Biji theme CSS served from /theme/ in the
// same container (COPY'd into /openedx/dist/theme/ at Docker build time).
window.ENV_CONFIG = {
  LMS_BASE_URL: 'https://academy.biji-biji.com',
  STUDIO_BASE_URL: 'https://studio.academy.biji-biji.com',
  LOGIN_URL: 'https://academy.biji-biji.com/login',
  LOGOUT_URL: 'https://academy.biji-biji.com/logout',
...
window.PARAGON_THEME = {
  ...
  brand: {
    version: '1.0.0',
    themeUrls: {
      core: { fileName: './theme/biji-biji-brand.min.css' },
      defaults: { light: 'light' },
      variants: {
        light: { fileName: './theme/biji-biji-brand-light.min.css' },
      },
    },
  },
};
