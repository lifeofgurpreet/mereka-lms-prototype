...
# │                                                                              │
# │ The LMS pod loads settings from                                              │
# │   /openedx/edx-platform/lms/envs/tutor/production.py                         │
# │ which is generated by Tutor from                                             │
# │   infrastructure/tutor/plugins/mereka_lms.py (+ patches under                │
# │   infrastructure/tutor/patches/).                                            │
# │                                                                              │
# │ Edits to this file produce no runtime effect. Verifier greps against this    │
# │ file are NOT runtime proof (slice-63/64 evidence).                           │
# │                                                                              │
# │ To change LMS runtime config:                                                │
# │   - Tutor plugin hook:  infrastructure/tutor/plugins/mereka_lms.py           │
# │   - Tutor patch:        infrastructure/tutor/patches/*                       │
# │   - Waffle flag:        manage.py lms waffle_flag <name> --activate          │
# │                                                                              │
