...
class NotificationPreferenceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('user_id', 'message_type', 'channel', 'enabled')
        }),
        ('Consent', {
...
class PreferenceAuditLogAdmin(admin.ModelAdmin):
    list_display = ('user_id', 'message_type', 'channel', 'old_value', 'new_value', 'change_source', 'timestamp')
    list_filter = ('message_type', 'channel', 'change_source', 'timestamp')
    search_fields = ('user_id',)
    readonly_fields = ('user_id', 'message_type', 'channel', 'old_value', 'new_value', 'consent_version', 'ip_address_hash', 'timestamp', 'change_source')
    ordering = ('-timestamp',)
    ...
    fieldsets = (
        ...
        ('Preference Change', {
            'fields': ('message_type', 'channel', 'old_value', 'new_value')
        }),
        ('Metadata', {
