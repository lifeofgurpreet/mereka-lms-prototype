...
|----------|---------|-------------|
| `MEREKA_LMS_EXTRA_HOSTS` | `["academy.biji-biji.com", "skillourfuture.academy.mereka.io"]` | Additional LMS domains |
| `MEREKA_LMS_EXTRA_CSRF_ORIGINS` | `["https://academy.biji-biji.com", "https://skillourfuture.academy.mereka.io"]` | CSRF trusted origins |
