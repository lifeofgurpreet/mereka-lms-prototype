#!/usr/bin/env node
/**
 * Export certificate/completion data from Kajabi
 * 
 * Since Kajabi's Public API doesn't expose certificates directly, this script:
 * 1. Attempts to find completion data via customer/product relationships
 * 2. Exports purchase data (which indicates enrollment/completion eligibility)
 * 3. Documents manual certificate export process
 * 
 * Usage:
