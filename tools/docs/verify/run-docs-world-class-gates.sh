...
run_step "report-nonstub-transitional-files" python3 tools/docs/verify/report-nonstub-transitional-files.py --fail-on-nonstub --summary-file "$NONSTUB_TRANSITIONAL_SUMMARY"
