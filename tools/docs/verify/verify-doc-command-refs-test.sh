...
run_case() {
  ...
  args+=("$ROOT_DIR/$file")
  local cmd=(bash tools/docs/verify/verify-doc-command-refs.sh "${args[@]}")
  local return_code=0
...
`tools/docs/verify/verify-docs-policy.sh:12`
`tools/docs/verify/verify-docs-policy.sh#L12`

```bash
cat tools/docs/verify/verify-docs-policy.sh:8
cat tools/docs/verify/verify-docs-policy.sh#L8
```
EOF_DOC
...
`a/tools/docs/verify/verify-docs-policy.sh`
`b/tools/docs/verify/verify-docs-policy.sh`
`a/tools/docs/verify/verify-docs-policy.sh:20`

```bash
cat b/tools/docs/verify/verify-docs-policy.sh#L20
```
EOF_DOC
...
- [policy](tools/docs/verify/verify-docs-policy.sh#L12)
- [policy line](tools/docs/verify/verify-docs-policy.sh:12)
EOF_DOC
...
<tools/docs/verify/verify-docs-policy.sh>
<tools/docs/verify/verify-docs-policy.sh#L10>
EOF_DOC
...
[policy]: tools/docs/verify/verify-docs-policy.sh
[policy-line]: <tools/docs/verify/verify-docs-policy.sh#L10>
EOF_DOC
