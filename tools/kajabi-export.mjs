 ...
 *
 * Usage examples:
 *   node tools/kajabi-export.mjs --resources contacts,customers
 *   node tools/kajabi-export.mjs --resources courses --site 2147565329 --start-page 1 --end-page 5
 *   node tools/kajabi-export.mjs --resources courses --skip-course-details
 *
