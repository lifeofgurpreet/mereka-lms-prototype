...
2. **Never create a spec without frontmatter.** Every spec MUST have YAML frontmatter with at least: title, type, status, owner, vehicle, last_updated. Use `specs/templates/spec-template.md`.
