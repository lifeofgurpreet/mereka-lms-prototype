...
def test_truth_ledger_builds_partial_payload_from_acceptance_summary(tmp_path: Path) -> None:
    ...
    summary = {
        ...
        "release_identity": {
            "release_id": "ro-rb-242e1178-20260403T111930Z",
            "release_bundle_id": "rb-242e1178-20260403T111930Z",
    ...
    assert payload["release_identity"]["release_id"] == "ro-rb-242e1178-20260403T111930Z"
...
def test_truth_ledger_cli_emits_file_from_dry_run_bundle(tmp_path: Path) -> None:
        ...
        json.dumps(
            {
                "release_id": "ro-rb-242e1178-20260403T111930Z",
                "app_commit_sha": "55c932f75d4144cba8d5a6789aa7ab0fa8dd426a",
                "build": {"release_bundle_id": "rb-242e1178-20260403T111930Z"},
                "images": {
                    "openedx": {
    ...
    assert payload["release_truth"]["release_id"] == "ro-rb-242e1178-20260403T111930Z"
    jsonschema.validate(payload, load_ledger_schema())
