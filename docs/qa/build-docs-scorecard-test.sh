...
python3 docs/qa/build-docs-scorecard.py --summary-file "$PASS_SUMMARY" --out "$PASS_SCORE" --min-score 80

if python3 docs/qa/build-docs-scorecard.py --summary-file "$FAIL_SUMMARY" --out "$FAIL_SCORE" --min-score 80 --fail-on-low-score; then
