...
| OBS-045 | P1 | Governance | Add "observability release checklist" gate to deployment playbook | OBS-041 | docs/ops/runbooks/RELEASE_CHECKLIST.md | release process requires observability sign-off step | done |
...
8. Add nonprod tracing evidence runbook step to `docs/ops/runbooks/OBSERVABILITY_PARITY_WORKFLOW_SETUP.md` and `OBSERVABILITY_PARITY_MATRIX.md`. **Done** (nonprod step and tracing artifact requirements documented).
...
| OBS-052 | P0 | Parity | Define and document dashboard parity scope: GCP dashboards vs Grafana dashboards (artifact classification) | OBS-051 | `docs/ops/runbooks/OBSERVABILITY_PARITY_WORKFLOW_SETUP.md` update | Runtime parity script and parity matrix ignore/handle non-GCP dashboard artifacts without silent false negatives | done |
