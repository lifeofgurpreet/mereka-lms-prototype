...
| OBS-008 | P0 | Coverage | Add scrape label consistency checks to validation scripts | OBS-007 | script rule updates | validation fails if required labels/selectors drift | in_progress |
