...
- **Drive + Airtable Video Inventory**: [migrations/drive-airtable/README.md](migrations/drive-airtable/README.md) - Course-first pipeline for nested Drive video mapping, subtitle review, and lesson linking.
