...
| `docs/guides/branding/README.md` | Canonical branding guidance surface | Canonical |
...
| `docs/ops/ci-cd/README.md` | Canonical CI/CD operator surface | Canonical |
...
- Do not treat `docs/operations/README.md`, `docs/runbooks/README.md`, `docs/onboarding/README.md`, or `docs/architecture/README.md` as living authority.
