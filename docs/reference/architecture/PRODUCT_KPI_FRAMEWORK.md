...
- Aspects analytics setup: `docs/reference/operations/ASPECTS_ANALYTICS_SETUP.md`
- Analytics decision gate: `docs/policies/architecture/ANALYTICS_DECISION_GATE.md`
- Data retention policy: `docs/policies/operations/ANALYTICS_DATA_RETENTION.md`
