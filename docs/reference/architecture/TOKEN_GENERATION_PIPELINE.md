...
- **Token Reference Integrity**: `docs/reference/architecture/TOKEN_REFERENCE_INTEGRITY.md` — 3-layer architecture, token inventory, drift warnings
- **Design Token Spec**: `specs/design-tokens.md` (AC-UITKN-001..012)
- **Frontend Audit Checklist**: `../../reports/2026/audits/FRONTEND_AUDIT_CHECKLIST.md` — Token correctness, usage lint
- **WCAG Contrast Compliance**: `docs/policies/architecture/ACCESSIBILITY_CONFORMANCE_POLICY.md` — Token contrast verification
...
|----|-------------|---------------------|
| AC-TKPIPE-001 | Contract document defines single-source pipeline architecture | This document exists at `docs/reference/architecture/TOKEN_GENERATION_PIPELINE.md` |
