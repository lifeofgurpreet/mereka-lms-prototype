...
- [`docs/policies/architecture/COPY_TERMINOLOGY_CONTRACT.md`](../../policies/architecture/COPY_TERMINOLOGY_CONTRACT.md) — domain → brand copy table
- [`docs/policies/architecture/MULTISITE_UX_CONSISTENCY.md`](../../policies/architecture/MULTISITE_UX_CONSISTENCY.md) — SITE_VARIANTS UX consistency requirements
- [`docs/ops/runbooks/architecture/FOOTER_SLOT_MIGRATION.md`](../../ops/runbooks/architecture/FOOTER_SLOT_MIGRATION.md) — footer slot wiring contract
