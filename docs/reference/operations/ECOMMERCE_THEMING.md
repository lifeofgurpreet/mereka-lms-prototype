# Ecommerce Template Theming Reference
...
This reference documents the legacy Oscar ecommerce theming surface that still matters during the transition period.
