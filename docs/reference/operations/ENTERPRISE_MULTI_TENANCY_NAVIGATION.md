...
- [`docs/concepts/architecture/MULTISITE.md`](MULTISITE.md) - Domain + platform configuration details for tenant deployment.
- [`docs/policies/operations/MULTISITE_GOVERNANCE.md`](MULTISITE_GOVERNANCE.md) - Governance checks and recurring controls.
...
- [`../ops/security/RELEASE_CHECKLIST_DOMAIN_SECRETS.md`](../ops/security/RELEASE_CHECKLIST_DOMAIN_SECRETS.md) - Domain/secret change safety checks.
...
- [`docs/concepts/architecture/MULTISITE.md`](MULTISITE.md) - Tenant model (shared services vs per-tenant domains).
...
- [`docs/status/readiness/TENANT_BRANDING_READINESS_RAG.md`](TENANT_BRANDING_READINESS_RAG.md) - Branding readiness state and gaps.
...
- [`docs/runbooks/operations/TENANT_BRANDING_TROUBLESHOOTING.md`](TENANT_BRANDING_TROUBLESHOOTING.md) - Branding breakages and fixes.
...
1. Start with `TENANT_PROVISIONING.md` and `ops/runbooks/tenant-provisioning-runbook.md` before making portal/branding changes.
...
4. Verify enterprise services health with `docs/runbooks/operations/ENTERPRISE_SERVICES_RUNBOOK.md` and `ops/runbooks/enterprise-services-runbook.md`.
5. Use `docs/runbooks/operations/ENTERPRISE_SERVICES_RUNBOOK.md` and the enterprise portals for license/tier lifecycle ops.
