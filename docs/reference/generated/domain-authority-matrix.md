...
_Generated from `deploy/k8s/tenancy/tenant-registry.yaml` v1.5.0 on 2026-04-06._
...
|--------|-----|----------|------|--------|-----------|---------|------------|----------|
| biji-biji | production | `analytics.academy.biji-biji.com` | analytics | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| biji-biji | production | `credentials.academy.biji-biji.com` | credentials | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| biji-biji | production | `admin.academy.biji-biji.com` | enterprise-admin | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| biji-biji | production | `learner.academy.biji-biji.com` | enterprise-learner | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| biji-biji | production | `apps.academy.biji-biji.com` | mfe | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| biji-biji | production | `preview.academy.biji-biji.com` | preview | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| biji-biji | production | `academy.biji-biji.com` | primary | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| biji-biji | production | `studio.academy.biji-biji.com` | studio | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| mereka | production | `analytics.academyv2.mereka.io` | analytics | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| mereka | production | `auth0.mereka.io` | auth | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| mereka | production | `credentials.academyv2.mereka.io` | credentials | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| mereka | production | `discovery.academyv2.mereka.io` | discovery | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| mereka | production | `ecommerce.academyv2.mereka.io` | ecommerce | deprecated | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| mereka | production | `admin.academyv2.mereka.io` | enterprise-admin | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| mereka | production | `learner.academyv2.mereka.io` | enterprise-learner | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| mereka | production | `forum.academyv2.mereka.io` | forum | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| mereka | production | `apps.academyv2.mereka.io` | mfe | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| mereka | production | `notes.academyv2.mereka.io` | notes | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| mereka | production | `preview.academyv2.mereka.io` | preview | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| mereka | production | `academyv2.mereka.io` | primary | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| mereka | production | `studio.academyv2.mereka.io` | studio | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| skillourfuture | production | `analytics.skillourfuture.academyv2.mereka.io` | analytics | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `credentials.skillourfuture.academyv2.mereka.io` | credentials | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `admin.skillourfuture.academyv2.mereka.io` | enterprise-admin | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `learner.skillourfuture.academyv2.mereka.io` | enterprise-learner | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `apps.skillourfuture.academyv2.mereka.io` | mfe | deprecated | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `apps.skillourfuture.academyv2.mereka.io` | mfe | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `preview.skillourfuture.academyv2.mereka.io` | preview | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `skillourfuture.academy.mereka.io` | primary | active | mereka-lms | rke2-prod | mereka-lms-prod | P0 |
| skillourfuture | production | `skillourfuture.academyv2.mereka.io` | primary | active | mereka-lms | rke2-prod | mereka-lms-prod | P1 |
| skillourfuture | production | `studio.skillourfuture.academyv2.mereka.io` | studio | deprecated | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
| skillourfuture | production | `studio.skillourfuture.academyv2.mereka.io` | studio | active | mereka-lms | rke2-prod | mereka-lms-prod | P2 |
