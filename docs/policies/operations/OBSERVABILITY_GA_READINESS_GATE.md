...
- Retention artifacts are compliant with `docs/policies/operations/OBSERVABILITY_ARTIFACT_RETENTION_MATRIX.md`.
...
- `docs/policies/operations/OBSERVABILITY_GA_READINESS_GATE.md` (filled with dates, env list, and reviewer)
