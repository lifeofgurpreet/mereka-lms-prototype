...
All DSARs are tracked in a private register (`docs/policies/operations/DATA_RETENTION_POLICY.md` — not committed to the public repo). Each entry includes: request hash, request type, received date, verified date, completed date, and steps executed.
