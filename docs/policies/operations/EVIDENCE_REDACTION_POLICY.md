...
- CI growth budget: `./scripts/qa/verify-evidence-sprawl-budget.sh` enforces tracked evidence file/size budgets from `verification/manifests/evidence_sprawl_budget.json`
