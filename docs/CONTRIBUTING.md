...
- `docs/operations/README.md`, `docs/runbooks/README.md`, `docs/onboarding/README.md`, `docs/guides/branding/README.md`, `docs/architecture/README.md`, and `docs/ops/ci-cd/README.md` are retired compatibility tombstones.
