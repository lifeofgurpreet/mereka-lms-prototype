...
- `docs/operations/README.md`, `docs/runbooks/README.md`, `docs/onboarding/README.md`, `docs/branding/README.md`, `docs/architecture/README.md`, and `docs/ci-cd/README.md` are retired compatibility tombstones.
