...
2. **`/scripts/migrations/mct/transform_data.py`**
...
The `CourseEnrollment.get_or_create_enrollment()` method returns a single object, NOT a tuple. Fixed in `/scripts/migrations/mct/openedx_bulk_import_mct.py`:
