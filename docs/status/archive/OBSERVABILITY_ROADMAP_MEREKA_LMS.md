...
- canonical_readiness_report: `docs/status/readiness/OBSERVABILITY_FIRST_CLASS_READINESS_REPORT.md`
...
Expected outputs:
1. `docs/reference/operations/OBSERVABILITY_PARITY_MATRIX.md` (created)
