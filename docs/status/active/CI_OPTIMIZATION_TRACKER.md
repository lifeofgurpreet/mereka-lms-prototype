...
- [x] **Task 5.5**: Migrate remaining LEGACY workflows (issue #124 follow-up)
  ...
  - `docs/policies/operations/CI_RUNNER_POLICY.md` audit table updated to CONFORM for all 11 jobs
...
- [x] **Task 7.3**: Update runner documentation for ARC
  - Modified (added ARC runner labels + reference to `CI_CD_RUNNERS.md`):
    - `docs/reference/operations/CI_CD_SETUP.md` ✓ (new "Self-Hosted Runners (ARC)" section with label table + link)
    - `docs/reference/operations/GITHUB_ACTIONS_COST_MONITORING.md` ✓ ("Self-Hosted Runners" section updated from "Future" to "Implemented" with ARC cost estimates + link to `CI_CD_RUNNERS.md`)
...
- [x] **Task 7.4**: Cross-reference new docs
  - `docs/reference/operations/CI_CD_SETUP.md` ✓ — references `CI_CD_RUNNERS.md` in new ARC section + See Also
  - `docs/reference/operations/GITHUB_ACTIONS_COST_MONITORING.md` ✓ — already referenced `CI_PIPELINE_COST_OPTIMIZATION.md` and `CI_OPTIMIZATION_TRACKER.md` in Related Documentation section
