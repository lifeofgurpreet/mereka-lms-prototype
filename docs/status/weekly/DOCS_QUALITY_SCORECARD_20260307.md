...
| `tools/docs/verify/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=140, candidates=1496, inline=1032, shell=464, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
| `tools/docs/verify/verify-doc-link-integrity.sh` | unknown | link integrity summary | files=137, broken_links=0 |
