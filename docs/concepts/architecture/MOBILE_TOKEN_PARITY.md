...
- **T107 — Design Tokens** (`docs/concepts/architecture/TOKEN_GENERATION_PIPELINE.md`): Canonical
...
- **T032 — Mobile deployment** (`docs/operations/MOBILE_DEPLOYMENT.md`): iOS is active on
...
`docs/operations/MOBILE_DEPLOYMENT.md`). Additionally, the bundle ID in the AASA
...
| `docs/concepts/architecture/TOKEN_GENERATION_PIPELINE.md` | Token pipeline architecture (T107) |
| `docs/operations/MOBILE_DEPLOYMENT.md` | Mobile deployment ops (T032) |
