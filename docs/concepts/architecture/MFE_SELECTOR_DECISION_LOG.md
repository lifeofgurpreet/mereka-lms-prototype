...
grep -E "^\| SEL-" docs/concepts/architecture/MFE_SELECTOR_DECISION_LOG.md | \
...
diff <(grep "SEL-" docs/concepts/architecture/MFE_SELECTOR_DECISION_LOG.md | awk -F'|' '{print $3}' | sort) \
