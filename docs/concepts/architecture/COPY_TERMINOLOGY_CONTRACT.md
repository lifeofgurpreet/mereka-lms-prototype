...
- See `docs/concepts/architecture/FOOTER_SLOT_MIGRATION.md` for footer slot wiring
...
- **MFE Footer v2 Design**: `docs/concepts/architecture/FOOTER_SLOT_MIGRATION.md` — Footer variant mapping
