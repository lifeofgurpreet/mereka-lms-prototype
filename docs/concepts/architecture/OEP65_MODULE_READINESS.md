...
| `docs/concepts/architecture/MFE_RUNTIME_CONFIG.md` | Full runtime config migration plan |
| `docs/concepts/architecture/TUTOR_PATCHES_INVENTORY.md` | Bash patch classification and risk assessment |
