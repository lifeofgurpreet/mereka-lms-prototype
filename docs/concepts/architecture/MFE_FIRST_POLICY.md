...
**Full slot catalog**: `docs/concepts/architecture/MFE_PLUGIN_SLOT_INVENTORY.md` (100+ slots across 14 MFEs)
...
- **Slot Inventory**: `docs/concepts/architecture/MFE_PLUGIN_SLOT_INVENTORY.md` (100+ slots)
- **MFE Versions**: `docs/concepts/architecture/MFE_VERSIONS.md` (active MFEs)
