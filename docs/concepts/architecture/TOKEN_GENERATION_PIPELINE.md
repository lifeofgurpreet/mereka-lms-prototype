...
- **Token Reference Integrity**: `docs/concepts/architecture/TOKEN_REFERENCE_INTEGRITY.md` — 3-layer architecture, token inventory, drift warnings
- **Design Token Spec**: `specs/design-tokens.md` (AC-UITKN-001..012)
- **Frontend Audit Checklist**: `../qa/reports/FRONTEND_AUDIT_CHECKLIST.md` — Token correctness, usage lint
- **WCAG Contrast Compliance**: `docs/concepts/architecture/ACCESSIBILITY_CONFORMANCE_POLICY.md` — Token contrast verification
...
|----|-------------|---------------------|
| AC-TKPIPE-001 | Contract document defines single-source pipeline architecture | This document exists at `docs/concepts/architecture/TOKEN_GENERATION_PIPELINE.md` |
