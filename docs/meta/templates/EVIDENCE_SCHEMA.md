...
5. **Retention**: 30 days minimum (see `docs/runbooks/operations/BRANDING_RELEASE_RUNBOOK.md`)
...
- `docs/policies/operations/EVIDENCE_REDACTION_POLICY.md` — Required redaction policy for committed evidence
- `docs/runbooks/operations/BRANDING_RELEASE_RUNBOOK.md` — Evidence retention policy
- `docs/runbooks/operations/TENANT_ONBOARDING_PLAYBOOK.md` — Onboarding evidence template
