...
- Total findings: 10
- Status counts: {"FIXED": 6, "INVALIDATED": 2, "PARTIAL": 2}
...
| RTA-06 | repo_truth_audit | PARTIAL | medium | medium | docs/meta/knowledge/WAVE5_EXECUTION_TRACKER.md<br>docs/meta/contracts/WAVE6_EXECUTION_TRACKER.md<br>docs/archive/reports/docs-program-scorecard-20260306.md | Introduce explicit program prefixes in read-first and handoff surfaces so wave terms do not collide. |
...
- Severity: `medium`
- Owner: `platform-team`
- Files: `docs/meta/knowledge/WAVE5_EXECUTION_TRACKER.md, docs/meta/contracts/WAVE6_EXECUTION_TRACKER.md, docs/archive/reports/docs-program-scorecard-20260306.md`
- Proof command: `rg -n "Wave 2B|Wave 5|Wave 6" docs/meta docs/archive/reports`
- Risk: `medium`
- Notes: overlapping_wave_vocab=docs/meta/knowledge/WAVE5_EXECUTION_TRACKER.md, docs/meta/contracts/WAVE6_EXECUTION_TRACKER.md, docs/archive/reports/docs-program-scorecard-20260306.md
