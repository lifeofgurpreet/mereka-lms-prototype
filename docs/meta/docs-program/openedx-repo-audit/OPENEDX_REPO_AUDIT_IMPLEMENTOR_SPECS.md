...
Source tracker: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_ARCH_HYGIENE_AUDIT_TRACKER.md`  
...
- `#215`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_215_PACKET.md`
- `#216`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_216_PACKET.md`
- `#217`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_217_PACKET.md`
- `#218`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_218_PACKET.md`
- `#219`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_219_PACKET.md`
- `#220`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_220_PACKET.md`
- `#221`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_221_PACKET.md`
- `#222`: `docs/meta/docs-program/openedx-repo-audit/OPENEDX_REPO_AUDIT_ISSUE_222_PACKET.md`
...
- Canonical release flow exists in docs and script (`docs/reference/operations/CANONICAL_DEPLOY_CONTRACT.md`, `scripts/infra/release-openedx-gitops.sh`) but older paths remain available.
...
4. Add docs/policies/operations/REPO_BOUNDARIES.md mapping:
