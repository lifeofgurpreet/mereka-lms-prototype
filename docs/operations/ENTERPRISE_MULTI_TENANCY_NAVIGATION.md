...
- `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md` - Operational surface for enterprise microservices.
...
4. Verify enterprise services health with `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md` and `ops/runbooks/enterprise-services-runbook.md`.
