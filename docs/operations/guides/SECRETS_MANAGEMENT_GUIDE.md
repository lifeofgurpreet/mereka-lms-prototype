...
**Prerequisites**: Read `docs/operations/SECRET_ROTATION_CHECKLIST.md` for full procedure.
...
### Operations Docs
- **Rotation checklist**: `docs/operations/SECRET_ROTATION_CHECKLIST.md` (step-by-step)
- **Secrets inventory**: `docs/operations/SECRETS_SNAPSHOT.md` (complete list)
- **Infisical keys**: `docs/operations/INFISICAL_MEREKA_LMS_KEYS.md` (detailed inventory)
- **Domain secrets**: `docs/operations/RELEASE_CHECKLIST_DOMAIN_SECRETS.md` (multi-site release)
