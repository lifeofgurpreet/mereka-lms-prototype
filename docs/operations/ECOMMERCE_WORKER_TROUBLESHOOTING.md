...
| `docs/operations/ECOMMERCE_DEPRECATION_INVENTORY.md` | All Oscar references + disposition |
| `docs/operations/ECOMMERCE_OAUTH_TROUBLESHOOTING.md` | OAuth2 client setup for Oscar |
