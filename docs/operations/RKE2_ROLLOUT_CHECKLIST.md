...
- [ ] **[manual]** Verify Oscar deprecation inventory complete: `docs/operations/ECOMMERCE_DEPRECATION_INVENTORY.md`
...
- [ ] **[manual]** Review `docs/operations/ALERT_SEVERITY_MATRIX.md` — all severity levels mapped to receivers
- [ ] **[manual]** Confirm on-call rotation is current: `docs/operations/ONCALL_ROTATION.md`
...
- [ ] **[manual]** Verify backup coverage matrix is current: `docs/operations/BACKUP_COVERAGE_MATRIX.md`

### 4.3 Restore Drill

- [ ] **[manual]** Restore drill has been run within the last 30 days
  - Evidence: `docs/operations/DR_TEST_RESULTS.md`
...
- [ ] Loki retention policy is set (default: 30 days):
  ...
  ```
- [ ] **[manual]** Retention aligns with data retention policy: `docs/operations/ANALYTICS_DATA_RETENTION.md`
...
- [ ] `docs/operations/TROUBLESHOOTING.md` — current and covers RKE2-specific issues
- [ ] `docs/operations/RKE2_DEV_READINESS.md` — covers bootstrap procedure
- [ ] `docs/operations/RKE2_ROLLOUT_MATRIX.md` — gate-by-gate rollout steps
- [ ] `docs/operations/MAINTENANCE_WINDOWS.md` — scheduled maintenance process
- [ ] `docs/operations/INCIDENT_TEMPLATES.md` — incident response templates
- [ ] `docs/operations/ONCALL_ROTATION.md` — current on-call contacts
- [ ] `docs/operations/BACKUP_COVERAGE_MATRIX.md` — what is backed up and where
...
- [ ] `docs/operations/ECOMMERCE_DEPRECATION_INVENTORY.md` — Oscar removal status documented
- [ ] `docs/operations/LEGACY_ECOMMERCE_REMOVAL_CHECKLIST.md` — removal steps tracked
