...
> **Related**: `docs/operations/runbooks/DEPLOYMENT_RUNBOOK.md`, `docs/operations/runbooks/DISASTER_RECOVERY.md`
...
If data loss exceeds acceptable threshold, **do not proceed**. Escalate to disaster recovery team and consult `docs/operations/runbooks/DISASTER_RECOVERY.md`.
...
**Template**: Use the post-mortem template at `docs/operations/post-mortem-template.md` (if it doesn't exist, create it based on this checklist).
...
**Emergency contacts**: See `docs/operations/ONCALL.md` (if not exists, create with team contact info).

---

## Related Documentation

- **Deployment**: `docs/operations/runbooks/DEPLOYMENT_RUNBOOK.md`
- **Disaster Recovery**: `docs/operations/runbooks/DISASTER_RECOVERY.md`
- **Site Down**: `docs/operations/runbooks/site-down.md`
- **Database Issues**: `docs/operations/runbooks/database-issues.md`
