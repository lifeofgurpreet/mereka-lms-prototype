...
- [CI_CD_RUNNERS.md](CI_CD_RUNNERS.md) — ARC architecture, runner labels, PVC caching, GitHub App setup
- [CI_OPTIMIZATION_TRACKER.md](CI_OPTIMIZATION_TRACKER.md) — Phase tracker for CI cost optimization
- [CI_PIPELINE_COST_OPTIMIZATION.md](CI_PIPELINE_COST_OPTIMIZATION.md) — Cost analysis
