...
|------|-------------|--------|
| `docs/operations/tenant-hosting-readiness.md` | AC-OPS-201..205 | ✅ This file |
| `docs/operations/CANONICAL_DEPLOY_CONTRACT.md` | AC-OPS-051..054, 061..063, 111..114 | ✅ Closed (36va.1/2/5) |
| `docs/operations/DEPLOY_EVIDENCE_GATES.md` | AC-OPS-301..305 | ✅ Closed (3qy2) |
| `docs/operations/POSTDEPLOY_SMOKE_AND_INCIDENT.md` | AC-OPS-071..073, 090..093, 131..135 | ✅ Closed (36va.3/4) |
| `docs/operations/RKE2_ROLLOUT_MATRIX.md` | AC-RKE2-006..015 | ✅ Closed (2j6g.1/2) |
...
- `docs/operations/RKE2_ROLLOUT_MATRIX.md` — RKE2 gate-by-gate procedure
- `docs/operations/CANONICAL_DEPLOY_CONTRACT.md` — Build/tag/push flow, environment deltas
- `docs/operations/DEPLOY_EVIDENCE_GATES.md` — GKE parity proof commands
