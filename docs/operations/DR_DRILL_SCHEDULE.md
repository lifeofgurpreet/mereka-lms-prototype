...
| Drill runbook | `docs/operations/CLOUD_SQL_RESTORE_DRILL.md` |
...
Full procedure: `docs/operations/CLOUD_SQL_RESTORE_DRILL.md`
...
Full DR test results from the last one-off drill: `docs/operations/DR_TEST_RESULTS.md`
