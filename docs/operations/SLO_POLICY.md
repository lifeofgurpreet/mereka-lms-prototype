...
Alertmanager config: `deploy/k8s/base/monitoring/alertmanager-config.yaml`
...
- SLO dashboards: `docs/operations/SLO_DASHBOARDS_SETUP.md`
- SLA reporting: `docs/operations/SLA_REPORTING.md`
- Incident response: `docs/operations/INCIDENT_RESPONSE.md`
- Alert severity matrix: `docs/operations/ALERT_SEVERITY_MATRIX.md`
