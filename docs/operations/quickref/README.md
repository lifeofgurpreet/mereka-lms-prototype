...
- [K8s Operations Guide](../guides/K8S_OPERATIONS_GUIDE.md) - Comprehensive K8s procedures
- [Secrets Management Guide](../guides/SECRETS_MANAGEMENT_GUIDE.md) - Full secrets workflow
- [Multi-Site Guide](../guides/MULTI_SITE_GUIDE.md) - Multi-tenancy operations
- [Observability Guide](../guides/OBSERVABILITY_GUIDE.md) - Monitoring and alerting

### Other References

- [ACCESS_URLS.md](../ACCESS_URLS.md) - All service URLs and credentials
- [DEPLOYMENT_VERIFICATION.md](../DEPLOYMENT_VERIFICATION.md) - Post-deploy checklist
- [TUTOR_CONFIG_SAFETY.md](../TUTOR_CONFIG_SAFETY.md) - Config best practices
- [VERIFICATION_REPORT.md](../VERIFICATION_REPORT.md) - Latest validation results

### Project Documentation

- [CLAUDE.md](/home/gurpreet/projects/k8s/mereka-lms/CLAUDE.md) - Project overview and rules
- [AGENTS.md](/home/gurpreet/projects/k8s/mereka-lms/AGENTS.md) - Repository guidelines
