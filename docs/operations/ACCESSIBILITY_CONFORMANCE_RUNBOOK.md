...
Body:
  ...
  Remediation: See docs/operations/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md#remediation-notes-per-route
...
follow the exception process in [A11Y_CONTRAST_FOCUS_GATE.md](A11Y_CONTRAST_FOCUS_GATE.md#exception-process)
and add an entry to `docs/operations/A11Y_EXCEPTIONS.md`.
...
- `docs/operations/A11Y_EXCEPTIONS.md` — Active exception log
