...
| Document | Purpose |
|----------|---------|
| `docs/operations/TENANT_BRANDING_SURFACE_MATRIX.md` | Per-domain branding surface registry |
| `docs/operations/FOOTER_VARIANT_MATRIX.md` | Footer variant per domain |
| `docs/operations/TENANT_ISOLATION_EVIDENCE.md` | Cross-tenant isolation controls |
| `docs/operations/MULTISITE_GOVERNANCE.md` | Site + domain governance checklist |
