...
- [ ] **5. Configure DNS + SSL**:
  ...
  - See `docs/acfs/reference/domain-ssl-management.md`.
...
- [`docs/operations/FOOTER_VARIANT_MATRIX.md`](FOOTER_VARIANT_MATRIX.md) — per-domain footer skin (companion document)
