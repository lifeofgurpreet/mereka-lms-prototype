...
Add to the security exceptions register (create at `docs/operations/SECURITY_EXCEPTIONS.md` if absent):
...
- `docs/operations/SECRET_ROTATION_CHECKLIST.md` — secret rotation procedure
- `docs/operations/SECRETS_SNAPSHOT.md` — current secret inventory
