...
| Recovery evidence | `docs/operations/*_EVIDENCE.md` | `GKE_WORKLOAD_TRIAGE_EVIDENCE.md` |
...
- Runbook: `docs/operations/DEPLOY_EVIDENCE_GATES.md`
- Handoff: `docs/operations/RKE2_LMS_HANDOFF.md`
