...
| `#109` `mereka_lms.py` maintainability split | IN PROGRESS (phase-1 + phase-2 + phase-3 complete) | `docs/operations/PLUGIN_SPLIT_STATUS_2026-03-02.md`; compatibility-layer adoption expanded to additional verifiers (`verify-paragon-runtime.sh`, `verify-certificate-branding.sh`, `verify-analytics-key.sh`, `verify-frontend-version-truth.sh`); direct QA path-coupling reduced `98 → 92` |
...
- `#109`: `issuecomment-3981490806`, `issuecomment-3981538851`, `issuecomment-3981555936`
