...
| Repeated failures across 3+ consecutive daily runs | Review `docs/operations/TENANT_ONBOARDING_PLAYBOOK.md` and open a bead. |
...
- Tenant onboarding: `docs/operations/TENANT_ONBOARDING_PLAYBOOK.md`
- Multi-tenancy architecture: `docs/operations/ENTERPRISE_MULTI_TENANCY_NAVIGATION.md`
