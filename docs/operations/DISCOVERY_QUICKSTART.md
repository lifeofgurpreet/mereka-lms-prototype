...
**Details**: See [docs/operations/MONGODB_PERMISSIONS_ISSUE.md](./MONGODB_PERMISSIONS_ISSUE.md)
...
- **Full Setup Guide**: [DISCOVERY_DEMO_COURSE_SETUP.md](./DISCOVERY_DEMO_COURSE_SETUP.md)
- **MongoDB Issue**: [MONGODB_PERMISSIONS_ISSUE.md](./MONGODB_PERMISSIONS_ISSUE.md)
...
1. **Fix MongoDB permissions** - See [MONGODB_PERMISSIONS_ISSUE.md](./MONGODB_PERMISSIONS_ISSUE.md)
