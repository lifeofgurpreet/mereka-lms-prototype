...
| Execution doc | `docs/operations/PROCTORING_IMPLEMENTATION_READINESS.md` |
...
| Platform prep | OAuth2 app, deep-link URIs, branding endpoints documented (`docs/operations/MOBILE_OAUTH_PREPARATION.md`) |
...
| Execution doc | `docs/operations/evidence/1bdm1-mux-creds-mapping-cleanup.md` |
...
- `docs/operations/evidence/1bdm1-mux-creds-mapping-cleanup.md`
