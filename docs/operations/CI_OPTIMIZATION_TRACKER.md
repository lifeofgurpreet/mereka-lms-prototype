...
- [x] **Task 1.5**: Create operational documentation
  - Created: `docs/operations/CI_CD_RUNNERS.md`
...
- [x] **Task 7.2**: Update observability doc references for merged audit workflow
  - Modify (update workflow names from 3 separate → `daily-infrastructure-audit.yml`):
    - `docs/operations/CI_CD_SETUP.md` ✓ (workflow table + section renamed + detail block updated)
    - `docs/operations/OBSERVABILITY_ENHANCEMENT_PLAN.md` ✓ (2 references: CI automation entry + alert routing audit)
    - `docs/operations/OBSERVABILITY_ROADMAP_MEREKA_LMS.md` ✓ (parity matrix variables note)
...
- [x] **Task 7.3**: Update runner documentation for ARC
  - Modified (added ARC runner labels + reference to `CI_CD_RUNNERS.md`):
    - `docs/operations/CI_CD_SETUP.md` ✓ (new "Self-Hosted Runners (ARC)" section with label table + link)
    - `docs/operations/GITHUB_ACTIONS_COST_MONITORING.md` ✓ ("Self-Hosted Runners" section updated from "Future" to "Implemented" with ARC cost estimates + link to `CI_CD_RUNNERS.md`)
...
- [x] **Task 7.4**: Cross-reference new docs
  - `docs/operations/CI_CD_SETUP.md` ✓ — references `CI_CD_RUNNERS.md` in new ARC section + See Also
  - `docs/operations/GITHUB_ACTIONS_COST_MONITORING.md` ✓ — already referenced `CI_PIPELINE_COST_OPTIMIZATION.md` and `CI_OPTIMIZATION_TRACKER.md` in Related Documentation section
  - `docs/operations/README.md` ✓ — added new "CI/CD & Cost Optimization" category with 6 file entries
...
| `docs/operations/CI_CD_RUNNERS.md` | 1 | 1.5 |
