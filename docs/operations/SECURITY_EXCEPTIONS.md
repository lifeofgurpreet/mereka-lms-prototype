...
|----|-------------|------------|---------------|-------|---------------|-------------|--------|
| SEC-001 | Tutor 18.x Redwood past community support window | Medium | Upgrading to a newer Tutor release requires full image rebuild and smoke-test cycle. Accepted pending ADR-019 quarterly upgrade review; platform is patched at OS and container layers. | Platform Team | 2025-12-01 | 2026-06-30 | Active |
