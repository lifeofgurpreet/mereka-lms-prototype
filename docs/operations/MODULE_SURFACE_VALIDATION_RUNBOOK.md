# MODULE SURFACE VALIDATION RUNBOOK (Superseded)
_Audience: Ops • Owner: Docs Team • Last verified: 2026-03-06 • Status: superseded_

superseded_by: `../ops/runbooks/MODULE_SURFACE_VALIDATION_RUNBOOK.md`
This document has moved to:
- `../ops/runbooks/MODULE_SURFACE_VALIDATION_RUNBOOK.md`
