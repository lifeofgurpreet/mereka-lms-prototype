...
- **Created**: via `tutor local exec lms ./manage.py lms create_dot_application` (see `docs/operations/MOBILE_OAUTH_PROVISIONING.md`)
...
# (Manual verification - see docs/operations/MOBILE_OAUTH_PROVISIONING.md)
```
