...
| Document | Path |
|----------|------|
| Cross-repo handoff | `docs/operations/RKE2_LMS_HANDOFF.md` |
| Gate-by-gate rollout matrix | `docs/operations/RKE2_ROLLOUT_MATRIX.md` |
| DNS management | `docs/operations/CLOUDFLARE_DNS.md` |
| Troubleshooting | `docs/operations/TROUBLESHOOTING.md` |
| Post-deploy smoke | `docs/operations/POSTDEPLOY_SMOKE_AND_INCIDENT.md` |
| Canonical deploy contract | `docs/operations/CANONICAL_DEPLOY_CONTRACT.md` |
