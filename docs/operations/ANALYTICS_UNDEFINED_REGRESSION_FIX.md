...
`docs/operations/MFE_ANALYTICS_PLUGIN_PARITY.md` under the Exception Register before merging.
...
- `docs/operations/MFE_ANALYTICS_PLUGIN_PARITY.md` — full analytics injection architecture,
