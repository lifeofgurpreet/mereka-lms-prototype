...
GitHub Actions `uses:` pinning (action SHA pinning) is a separate concern covered by `docs/operations/ALLOWED_ACTIONS_POLICY.md`.
...
- `docs/operations/ALLOWED_ACTIONS_POLICY.md` — GitHub Actions `uses:` SHA pinning
- `docs/operations/SLSA_PROVENANCE.md` — Build provenance and image signing
- `docs/operations/SECURITY_INCIDENT_SUPPLY_CHAIN.md` — Supply-chain incident response
