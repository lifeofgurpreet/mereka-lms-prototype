...
|------|-------------|--------|
| `docs/operations/evidence/rke2/20260219T1935-rke2-argo-blocker.md` | ArgoCD git fetch timeout root cause | `87ea0b6` |
| `docs/operations/evidence/rke2/20260219T2120-rke2-github-connectivity.md` | SSH connectivity fix evidence | prior |
| `docs/operations/evidence/rke2/blocker-triage/20260219T2015-1exg-authn-triage.md` | 403/405 audit + authn shell verification | prior |
| `docs/operations/evidence/rke2/20260219T2240-rke2-deployment-blockers.md` | Post-sync blockers (ExternalSecrets + ImagePullBackOff) | `56fdf54` |
| `docs/operations/evidence/rke2/RKE2-DEPLOYMENT-RUNBOOK.md` | Full deployment runbook | `3428813` |
...
| `docs/operations/evidence/rke2/AZA7-OPERATIONAL-HANDOFF.md` | **This file** — aza7 handoff pack | this commit |
