...
Failures: all MFE authn CSS revision mismatch
  ...
  Root cause documented in: docs/operations/evidence/2qpt/mfe-revision-parity-evidence.md
...
All captures saved to `docs/operations/evidence/ui_finality/20260219-2032/dom-*.html`
...
```
docs/operations/evidence/ui_finality/20260219-2032/
