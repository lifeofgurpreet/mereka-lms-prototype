...
**File**: `docs/operations/evidence/mfe-surface-inventory.md`
...
- `docs/operations/evidence/mfe-surface-inventory.md` — Surface inventory (AC-FRONT-081)
- `docs/operations/evidence/footer-migration-diff.md` — Before/after diff from bead 1rns
- `docs/operations/evidence/selector-to-slot-migration-diff.md` — Slot migration diff from bead 2dcy.2
