...
Added comprehensive decision table to `docs/branding/BRANDING_OPERATOR_GUIDE.md`:
...
| `docs/branding/BRANDING_OPERATOR_GUIDE.md` | Added plugin-vs-theme decision table + per-tenant footer content section |
