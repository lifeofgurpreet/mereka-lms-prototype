...
**Ops model document:** `docs/branding/MULTI_TENANT_BRANDING_OPS.md`

---

## What the Ops Model Covers

`docs/branding/MULTI_TENANT_BRANDING_OPS.md` is the canonical reference for multi-tenant
...
| Document | Purpose |
|----------|---------|
| `docs/branding/MULTI_TENANT_BRANDING_OPS.md` | This bead's ops model (primary deliverable) |
| `docs/branding/TENANT_BRANDING_CONTRACT.md` | Brand pack schema, MFE config keys, fallback rules |
| `docs/branding/BRANDING_OPERATING_MODEL.md` | Canonical branding workflow (single-tenant baseline) |
