...
**Primary artifact**: `docs/branding/TENANT_CONFIG_HANDOFF.md`
...
- `docs/branding/TENANT_CONFIG_HANDOFF.md` — primary handoff guide
...
- `docs/operations/evidence/footer-slot-evidence-rollback-report.md` — related rollback evidence (bead 2dcy.8)
