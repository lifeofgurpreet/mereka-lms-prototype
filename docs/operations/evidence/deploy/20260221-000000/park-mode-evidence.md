...
```
Root cause and fix documented in prior evidence bundle (`docs/operations/evidence/gke-parity/20260220-181251/`).
...
**Full runbook**: `docs/operations/runbooks/prod-park-mode.md`
