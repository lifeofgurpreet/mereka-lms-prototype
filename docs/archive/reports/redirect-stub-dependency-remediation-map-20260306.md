...
| `docs/operations/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md` | `docs/ops/runbooks/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md` | `script` | scripts/qa/verify-a11y-tenant-branding.sh<br>scripts/qa/verify-a11y-authenticated-routes.sh<br>scripts/qa/verify-tenant-ui-smoke.sh |
| `docs/operations/ACCESS_URLS.md` | `docs/ops/quickref/access-urls.md` | `script` | scripts/qa/verify-operator-dashboards.sh |
| `docs/operations/ALLOWED_ACTIONS_POLICY.md` | `docs/ops/security/ALLOWED_ACTIONS_POLICY.md` | `script` | scripts/qa/verify-actions-pinned.sh |
| `docs/operations/CI_CD_SETUP.md` | `docs/ops/ci-cd/CI_CD_SETUP.md` | `script` | scripts/qa/lint-active-docs-env-model.sh |
| `docs/operations/CI_RUNNER_POLICY.md` | `docs/ops/ci-cd/CI_RUNNER_POLICY.md` | `script` | scripts/qa/verify-ci-runner-policy.sh |
| `docs/operations/DATA_ERASURE_RUNBOOK.md` | `docs/ops/runbooks/DATA_ERASURE_RUNBOOK.md` | `script` | scripts/qa/deprecated/verify-data-retention.sh<br>scripts/qa/verify-pii-inventory.sh |
| `docs/operations/ENTERPRISE_SERVICES_RUNBOOK.md` | `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md` | `script` | scripts/qa/verify-enterprise-all-acs.sh |
...
| `docs/operations/MONITORING.md` | `docs/ops/monitoring/MONITORING.md` | `script` | scripts/qa/verify-rke2-rollout-readiness.sh<br>scripts/qa/verify-operator-dashboards.sh |
| `docs/operations/OBSERVABILITY_PARITY_MATRIX.md` | `docs/ops/monitoring/OBSERVABILITY_PARITY_MATRIX.md` | `workflow` | .github/workflows/observability-compliance.yml |
...
| `docs/operations/SECRET_ROTATION_CHECKLIST.md` | `docs/ops/security/SECRET_ROTATION_CHECKLIST.md` | `script` | scripts/qa/verify-disaster-recovery.sh |
| `docs/operations/SECURITY_EXCEPTIONS.md` | `docs/ops/security/SECURITY_EXCEPTIONS.md` | `script+workflow` | .github/workflows/security-exceptions.yml<br>scripts/qa/verify-security-exceptions.sh |
| `docs/operations/VISUAL_REGRESSION.md` | `docs/ops/runbooks/VISUAL_REGRESSION_RUNBOOK.md` | `script` | scripts/qa/verify-visual-baselines.sh |
| `docs/operations/VISUAL_REGRESSION_RUNBOOK.md` | `docs/ops/runbooks/VISUAL_REGRESSION_RUNBOOK.md` | `script` | scripts/qa/verify-visual-parity-checkpoints.sh<br>scripts/qa/verify-visual-smoke-baseline.sh<br>scripts/qa/verify-ui-ux-hardening-bundle.sh |
...
2. `docs/qa/verify-docs-policy.sh` passed after dependency updates.
