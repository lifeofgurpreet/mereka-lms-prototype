...
| `docs/ops/runbooks/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md` | `docs/ops/runbooks/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md` | `script` | scripts/qa/verify-a11y-tenant-branding.sh<br>scripts/qa/verify-a11y-authenticated-routes.sh<br>scripts/qa/verify-tenant-ui-smoke.sh |
...
| `docs/ops/runbooks/DATA_ERASURE_RUNBOOK.md` | `docs/ops/runbooks/DATA_ERASURE_RUNBOOK.md` | `script` | scripts/qa/deprecated/verify-data-retention.sh<br>scripts/qa/verify-pii-inventory.sh |
| `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md` | `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md` | `script` | scripts/qa/verify-enterprise-all-acs.sh |
...
| `docs/operations/SECRET_ROTATION_CHECKLIST.md` | `docs/ops/runbooks/SECRET_ROTATION_CHECKLIST.md` | `script` | scripts/qa/verify-disaster-recovery.sh |
...
| `docs/ops/runbooks/VISUAL_REGRESSION_RUNBOOK.md` | `docs/ops/runbooks/VISUAL_REGRESSION_RUNBOOK.md` | `script` | scripts/qa/verify-visual-parity-checkpoints.sh<br>scripts/qa/verify-visual-smoke-baseline.sh<br>scripts/qa/verify-ui-ux-hardening-bundle.sh |
