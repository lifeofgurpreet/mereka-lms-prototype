...
1. **`docs/migrations/mct/EXPORT_GUIDE.md`** (583 lines) ⭐ **MAIN GUIDE**
...
8. **`docs/migrations/mct/SMOKE_TEST.md`** (Smoke test results)
...
**Maintained By:** See `docs/migrations/mct/EXPORT_GUIDE.md` → Support & Maintenance
