...
> **STALE WARNING (2026-02-27)**: This roadmap is 4+ months old. GKE production is now live. Many items may be completed or superseded. Cross-reference with `docs/guides/admin/K8S_OPERATIONS_GUIDE.md` for current state.
...
- **Secrets**: temporary bootstrap values live in `docs/ops/security/SECRETS_SNAPSHOT.md`; migrate them to Secret Manager and rotate immediately after bring-up.
