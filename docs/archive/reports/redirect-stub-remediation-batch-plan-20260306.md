# Redirect Stub Remediation Batch Plan 2026-03-06
_Audience: Platform Eng + Docs Lead • Owner: Platform Team • Last verified: 2026-03-06 • Status: supporting_

## Scope
- Remaining superseded stubs: 0
- This plan listed code references that pointed to legacy superseded docs and were updated in the execution batch.
...
- Legacy references to replace: 2
  ...
  - `docs/branding/PLUGIN_MIGRATION_SURVEY.md` -> `docs/guides/branding/PLUGIN_MIGRATION_SURVEY.md`

### `scripts/qa/deprecated/verify-data-retention.sh`
- Legacy references to replace: 1
  - `docs/ops/runbooks/DATA_ERASURE_RUNBOOK.md` -> `docs/ops/runbooks/DATA_ERASURE_RUNBOOK.md`
...
- Legacy references to replace: 1
  - `docs/ops/runbooks/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md` -> `docs/ops/runbooks/ACCESSIBILITY_CONFORMANCE_RUNBOOK.md`
...
- Legacy references to replace: 1
  - `docs/branding/TENANT_BRANDING_CONTRACT.md` -> `docs/guides/branding/TENANT_BRANDING_CONTRACT.md`
...
- Legacy references to replace: 1
  - `docs/operations/credential-key-rotation-runbook.md` -> `docs/ops/runbooks/credential-key-rotation-runbook.md`

### `scripts/qa/verify-credentials-ops.sh`
- Legacy references to replace: 4
  - `docs/operations/credential-backfill-runbook.md` -> `docs/ops/runbooks/credential-backfill-runbook.md`
  - `docs/operations/credential-issuance-failure-runbook.md` -> `docs/ops/runbooks/credential-issuance-failure-runbook.md`
  - `docs/operations/credential-key-rotation-runbook.md` -> `docs/ops/runbooks/credential-key-rotation-runbook.md`
  - `docs/operations/credential-verification-failure-runbook.md` -> `docs/ops/runbooks/credential-verification-failure-runbook.md`

### `scripts/qa/verify-disaster-recovery.sh`
- Legacy references to replace: 1
  - `docs/operations/SECRET_ROTATION_CHECKLIST.md` -> `docs/ops/runbooks/SECRET_ROTATION_CHECKLIST.md`

### `scripts/qa/verify-enterprise-all-acs.sh`
- Legacy references to replace: 1
  - `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md` -> `docs/ops/runbooks/ENTERPRISE_SERVICES_RUNBOOK.md`

### `scripts/qa/verify-enterprise-sso-readiness.sh`
- Legacy references to replace: 1
  - `docs/operations/ENTERPRISE_SSO_GUIDE.md` -> `docs/ops/security/ENTERPRISE_SSO_GUIDE.md`

### `scripts/qa/verify-github-actions-cost.sh`
- Legacy references to replace: 1
  - `docs/operations/GITHUB_ACTIONS_COST_MONITORING.md` -> `docs/ops/ci-cd/GITHUB_ACTIONS_COST_MONITORING.md`
...
- Legacy references to replace: 1
  - `docs/branding/MULTI_TENANT_BRANDING_OPS.md` -> `docs/guides/branding/MULTI_TENANT_BRANDING_OPS.md`
...
- Legacy references to replace: 1
  - `docs/branding/TENANT_CONFIG_HANDOFF.md` -> `docs/guides/branding/TENANT_CONFIG_HANDOFF.md`
...
- Legacy references to replace: 2
  ...
  - `docs/ops/runbooks/VISUAL_REGRESSION_RUNBOOK.md` -> `docs/ops/runbooks/VISUAL_REGRESSION_RUNBOOK.md`

### `scripts/qa/verify-vc-issuer.sh`
- Legacy references to replace: 1
  - `docs/operations/credential-key-rotation-runbook.md` -> `docs/ops/runbooks/credential-key-rotation-runbook.md`

### `scripts/qa/verify-vc-ops.sh`
- Legacy references to replace: 4
  - `docs/operations/credential-backfill-runbook.md` -> `docs/ops/runbooks/credential-backfill-runbook.md`
  - `docs/operations/credential-issuance-failure-runbook.md` -> `docs/ops/runbooks/credential-issuance-failure-runbook.md`
  - `docs/operations/credential-key-rotation-runbook.md` -> `docs/ops/runbooks/credential-key-rotation-runbook.md`
