...
2. **Package Build**: `ops/migrations/mct/scripts/build_course_packages.py`
   ```bash
   python3 ops/migrations/mct/scripts/build_course_packages.py \
...
```bash
# Import all courses
python3 ops/migrations/mct/scripts/import_courses_k8s.py \
