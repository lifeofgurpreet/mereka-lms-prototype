...
| 4 | Production GCP environment | Infra | ⚙️ In progress | Plan complete (see `docs/reference/operations/PRODUCTION_INFRASTRUCTURE_PLAN.md`). Est. $1,650-2,200/month. Multi-env Terraform structure ready. Next: Provision prod GCP project. |
