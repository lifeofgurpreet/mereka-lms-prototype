...
`docs/guides/branding/TENANT_ONBOARDING_PLAYBOOK.md` — complete AC-UX-150..154 evidence
...
agent-browser screenshot https://academyv2.mereka.io/ --output docs/archive/evidence/operations/evidence/screenshots/lms-mereka.png
agent-browser screenshot https://academy.biji-biji.com/ --output docs/archive/evidence/operations/evidence/screenshots/lms-biji.png
agent-browser screenshot https://skillourfuture.academy.mereka.io/ --output docs/archive/evidence/operations/evidence/screenshots/lms-sof.png
```
...
|-----|--------------|--------|
| `docs/guides/branding/TENANT_ONBOARDING_PLAYBOOK.md` | academyv2, biji-biji, skillourfuture | ✓ MATCH |
| `docs/guides/branding/MULTI_TENANT_BRANDING_OPS.md` | All 3 tenant hosts | ✓ MATCH |
| `docs/guides/branding/TENANT_BRANDING_CONTRACT.md` | Primary + alternate domains | ✓ MATCH |
| `docs/guides/branding/BRANDING.md` | Mereka Academy primary | ✓ (single-tenant scope by design) |
| `infrastructure/tutor/apply-patches.sh` | All 7 hosts | ✓ SOURCE OF TRUTH |

**Gaps identified:**
- `docs/guides/branding/` docs reference `studio.academyv2.mereka.io` but not `admin.academyv2.mereka.io` or `enterprise.academyv2.mereka.io` — these are enterprise portals added after initial branding docs were written. **WARN** — docs should be updated to include enterprise portal hosts.
...
### Related evidence
- `docs/archive/evidence/operations/evidence/wrsl1-ui-readiness-matrix.md` — AC-UI-101..105
- `docs/guides/branding/TENANT_ONBOARDING_PLAYBOOK.md` — AC-UX-150..154 (full playbook)
- `docs/guides/branding/MULTI_TENANT_BRANDING_OPS.md` — branding ops model
