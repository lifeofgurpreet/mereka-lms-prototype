...
```
docs/archive/evidence/operations/evidence/ui_continue/20260219-2216/
...
Prior evidence cross-reference: `docs/archive/evidence/operations/evidence/ui_finality/20260219-2032/` (DOM captures, footer spec verification)
