...
- `docs/archive/evidence/operations/evidence/rke2/5ngf-bootstrap-20260219-1205.log` — raw kubectl output
- `docs/archive/evidence/operations/evidence/rke2/5ngf-gates-20260219-1205.log` — full gate check output
- `docs/archive/evidence/operations/evidence/rke2/5ngf-1-bootstrap-gap-20260219-1215.md` — OrangeSnow cross-check
- `docs/archive/evidence/operations/evidence/rke2/5ngf-bootstrap-evidence.md` — gate-by-gate AC evidence
