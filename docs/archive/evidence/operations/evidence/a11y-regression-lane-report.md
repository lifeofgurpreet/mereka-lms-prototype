...
- Runbook at `docs/ops/runbooks/AUTHENTICATED_SMOKE_A11Y.md` (AC-FRONT-032)
...
| AC-FRONT-074 | Evidence artifact exists in docs/archive/evidence/operations/evidence/ | PASS |
...
| A11y regression lane runbook | `docs/ops/runbooks/A11Y_REGRESSION_LANE.md` |
