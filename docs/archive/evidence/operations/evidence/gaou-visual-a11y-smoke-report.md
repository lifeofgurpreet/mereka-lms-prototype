...
- `docs/archive/evidence/operations/evidence/a11y-regression-lane-report.md` — prior a11y regression evidence
- `docs/archive/evidence/operations/evidence/authenticated-smoke-a11y-report.md` — authenticated smoke + a11y evidence
- `docs/archive/evidence/operations/evidence/footer-slot-evidence-rollback-report.md` — footer slot migration evidence
