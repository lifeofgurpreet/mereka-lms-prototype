...
| Artifact | Path |
|----------|------|
| This file | `docs/archive/evidence/operations/evidence/wrsl1-ui-readiness-matrix.md` |
| NREUM clean build evidence | `docs/archive/evidence/operations/evidence/69qz-enterprise-mfe-clean-build.md` |
...
| Deployment runbook Section 9 | `docs/ops/runbooks/DEPLOYMENT_RUNBOOK.md` |
| Build/cache pipeline runbook | `docs/ops/runbooks/BUILD_CACHE_PIPELINE_RUNBOOK.md` |
