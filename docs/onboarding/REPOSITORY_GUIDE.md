...
**Related docs**: `docs/operations/DEPLOYMENT_RUNBOOK.md`
...
**Where to add**:
- New runbook → `docs/operations/`
- Getting started guide → `docs/onboarding/`
...
**Related docs**: `docs/STYLE_GUIDE.md`, `docs/README.md`
...
**Related docs**: `docs/IMPLEMENTATION_ROADMAP.md`, `team-skills/ONBOARDING.md` (V3 verification method)
...
- Service URLs: `docs/operations/ACCESS_URLS.md`
...
| Find URLs | `docs/operations/ACCESS_URLS.md` |
...
cat > docs/operations/MY_NEW_RUNBOOK.md <<'EOF'
# My New Runbook
...
- **Roadmap**: `docs/IMPLEMENTATION_ROADMAP.md` — Implementation progress
- **Onboarding**: `docs/onboarding/DEVELOPER_ONBOARDING.md` — Complete setup guide
