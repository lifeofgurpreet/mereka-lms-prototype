...
- [QUICK_REFERENCE.md](../QUICK_REFERENCE.md) - Bookmark this for daily commands
...
- [ ] **Read**: [K8s Operations Guide](../operations/guides/K8S_OPERATIONS_GUIDE.md) - Core operations
- [ ] **Bookmark**: [Quick Reference](../QUICK_REFERENCE.md) - Daily commands
- [ ] **Access**: [All system URLs](../operations/ACCESS_URLS.md) - LMS, Studio, observability
...
- [ ] **Read**: [Secrets Management Guide](../operations/guides/SECRETS_MANAGEMENT_GUIDE.md)
- [ ] **Understand**: Infisical → GCP Secret Manager → ExternalSecrets → K8s pipeline
- [ ] **Read**: [Multi-Site Guide](../operations/guides/MULTI_SITE_GUIDE.md) - Multi-domain setup
...
- [ ] **Read**: [MongoDB Atlas Guide](../operations/guides/MONGODB_ATLAS_GUIDE.md)
- [ ] **Read**: [Observability Guide](../operations/guides/OBSERVABILITY_GUIDE.md)
...
- [ ] **Read**: [Admin Login Guide](../operations/guides/ADMIN_LOGIN_GUIDE.md)
- [ ] **Practice**: Create test user in dev environment
- [ ] **Practice**: Grant platform admin permissions

#### Week 3: Enterprise Services
- [ ] **Read**: [Enterprise Services Guide](../operations/guides/ENTERPRISE_SERVICES_GUIDE.md)
...
- [ ] **Read**: [Deployment Runbook](../operations/runbooks/DEPLOYMENT_RUNBOOK.md)
...
- [ ] **Read**: [Site Down Runbook](../operations/runbooks/site-down.md) - **CRITICAL**
...
- [ ] **Read**: [Performance Degradation Runbook](../operations/runbooks/performance-degradation.md)
- [ ] **Read**: [Database Issues Runbook](../operations/runbooks/database-issues.md)
- [ ] **Read**: [K8s Operations Guide](../operations/guides/K8S_OPERATIONS_GUIDE.md)
- [ ] **Practice**: Run diagnostic commands on dev cluster

#### Day 4-5: Observability and Recovery
- [ ] **Read**: [Observability Guide](../operations/guides/OBSERVABILITY_GUIDE.md)
- [ ] **Read**: [Disaster Recovery Runbook](../operations/runbooks/DISASTER_RECOVERY.md)
...
- [ ] **Read**: [Auth Alert Runbook](../operations/runbooks/AUTH_ALERT_RUNBOOK.md)
...
- [ ] **Read**: [Database Architecture](../architecture/DATABASE_ARCHITECTURE.md)
- [ ] **Read**: [Multisite Analysis](../architecture/MULTISITE_ANALYSIS.md)
- [ ] **Read**: [Production Architecture Reality](../PRODUCTION_ARCHITECTURE_REALITY.md)
...
See [Site Down Runbook](../operations/runbooks/site-down.md) for full decision tree.
...
See [Performance Degradation Runbook](../operations/runbooks/performance-degradation.md) for full procedures.
...
See [Disaster Recovery Runbook](../operations/runbooks/DISASTER_RECOVERY.md) for restore procedures.
...
- [ ] **Read**: [Branding Guide](../BRANDING.md) - Theme customization
...
- [ ] **Read**: [Database Architecture](../architecture/DATABASE_ARCHITECTURE.md)
- [ ] **Read**: [Production Architecture Reality](../PRODUCTION_ARCHITECTURE_REALITY.md)
- [ ] **Read**: [Local Production Parity](../operations/LOCAL_PRODUCTION_PARITY.md)
...
- [ ] **Read**: [CI/CD Runbook](../operations/runbooks/CI_CD_RUNBOOK.md)
- [ ] **Read**: [Deployment Runbook](../operations/runbooks/DEPLOYMENT_RUNBOOK.md)
...
| Issue Type | First Contact | Escalation |
|------------|---------------|------------|
| Local setup fails | Check [TROUBLESHOOTING.md](../operations/runbooks/site-down.md) | Engineering team Slack |
| Build issues | Check [CI/CD Runbook](../operations/runbooks/CI_CD_RUNBOOK.md) | Senior Developer |
...
- [ ] **Read**: [Admin Login Guide](../operations/guides/ADMIN_LOGIN_GUIDE.md)
- [ ] **Access**: All admin URLs from [Access URLs](../operations/ACCESS_URLS.md)
- [ ] **Login**: Test login to LMS and Studio
- [ ] **Explore**: Admin panel, user management

#### Configuration Basics
- [ ] **Read**: [Multi-Site Guide](../operations/guides/MULTI_SITE_GUIDE.md)
- [ ] **Read**: [Auth and Permissions](../operations/AUTH_AND_PERMISSIONS.md)
...
- [ ] **Read**: [Domain Change Runbook](../operations/runbooks/DOMAIN_CHANGE_RUNBOOK.md)
...
- [ ] **Read**: [Tenant Provisioning Runbook](../runbooks/tenant-provisioning-runbook.md)
- [ ] **Shadow**: Senior admin provisioning new tenant
- [ ] **Practice**: Provision test tenant in dev

#### Week 3: SSO and Authentication
- [ ] **Read**: [Auth SSO Runbook](../operations/runbooks/AUTH_SSO_RUNBOOK.md)
- [ ] **Read**: [Auth SSO Enterprise Runbook](../runbooks/auth-sso-enterprise-runbook.md)
- [ ] **Understand**: Authentik OIDC integration
- [ ] **Practice**: Configure SSO for test tenant

#### Week 4: Payment and Integrations
- [ ] **Read**: [Purchase Gateway Runbook](../runbooks/purchase-gateway-runbook.md)
- [ ] **Read**: [External Registration Runbook](../runbooks/external-registration-runbook.md)
...
See [Tenant Provisioning Runbook](../runbooks/tenant-provisioning-runbook.md) for full procedure.
...
See [Auth SSO Runbook](../operations/runbooks/AUTH_SSO_RUNBOOK.md) for full procedure.
...
| SSO not working | Check [Auth SSO Runbook](../operations/runbooks/AUTH_SSO_RUNBOOK.md) | Platform Team |
| Payment issues | Check [Purchase Gateway Runbook](../runbooks/purchase-gateway-runbook.md) | Finance Team + Platform |
| User access issues | Follow [Admin Login Guide](../operations/guides/ADMIN_LOGIN_GUIDE.md) | Platform Operations |
...
2. **Never skip the 5-command diagnostic**
   - See [Site Down Runbook](../operations/runbooks/site-down.md)
...
1. **Never downgrade package versions to fix issues**
   ...
   - See [Version Safety Rules](~/.claude/rules/version-safety.md)
...
3. **Never change domain without following runbook**
   ...
   - Follow [Domain Change Runbook](../operations/runbooks/DOMAIN_CHANGE_RUNBOOK.md)
...
**SREs**:
- [Site Down Runbook](../operations/runbooks/site-down.md) - CRITICAL
...
**Operators/Admins**:
- [K8s Operations Guide](../operations/guides/K8S_OPERATIONS_GUIDE.md)
- [Secrets Management Guide](../operations/guides/SECRETS_MANAGEMENT_GUIDE.md)
- [Admin Login Guide](../operations/guides/ADMIN_LOGIN_GUIDE.md)
...
4. **Check**: [Troubleshooting](../operations/runbooks/site-down.md)
5. **Ask**: Engineering team Slack with error output

### Stuck on Incident

1. **Follow runbook**: [Site Down](../operations/runbooks/site-down.md) or [Performance Degradation](../operations/runbooks/performance-degradation.md)
