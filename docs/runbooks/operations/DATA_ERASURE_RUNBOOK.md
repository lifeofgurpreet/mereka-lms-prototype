...
Handles: `auth_user` anonymization, `auth_userprofile` deletion, `social_auth_usersocialauth` deletion, forum author anonymization, session invalidation, certificate revocation. Full details: `docs/runbooks/operations/GDPR_COMPLIANCE.md` §2.
...
- Data retention policy: `docs/policies/operations/DATA_RETENTION_POLICY.md`
- GDPR runbook: `docs/runbooks/operations/GDPR_COMPLIANCE.md`
