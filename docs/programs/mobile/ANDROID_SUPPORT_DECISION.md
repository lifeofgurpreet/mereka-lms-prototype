...
The mobile apps specification (`specs/proposals/mobile-apps-enterprise_spec.md`) outlines support for both iOS and Android mobile applications. Currently:
...
3. **Mobile spec status**:
   - `specs/proposals/mobile-apps-enterprise_spec.md`: status = "draft"
...
2. **Update mobile spec**: Add deferral notice to `specs/proposals/mobile-apps-enterprise_spec.md` indicating Android is not in scope for v1
...
- [ ] Add deferral notice to `specs/proposals/mobile-apps-enterprise_spec.md` (Android section)
...
- `specs/proposals/mobile-apps-enterprise_spec.md` (mobile strategy)
