...
- [FOOTER_VARIANT_MATRIX.md](../../operations/FOOTER_VARIANT_MATRIX.md) — Per-domain footer config
- [MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md](../../operations/MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md) — Slot migration status
- [MFE_SELECTOR_HARDENING_AUDIT.md](../../operations/MFE_SELECTOR_HARDENING_AUDIT.md) — Selector risk matrix
- [TOKEN_INTEGRITY_REMEDIATION.md](../../operations/TOKEN_INTEGRITY_REMEDIATION.md) — Token architecture
