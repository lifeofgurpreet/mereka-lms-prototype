...
Create or update `../../policies/operations/A11Y_EXCEPTIONS.md` (create if absent) with
...
- Add the exception entry to `../../policies/operations/A11Y_EXCEPTIONS.md`.
...
- `docs/policies/architecture/ACCESSIBILITY_CONFORMANCE_POLICY.md` — Platform-wide a11y policy
- `../../policies/operations/A11Y_EXCEPTIONS.md` — Active exception log (create when first needed)
- `scripts/qa/verify-accessibility.sh` — Broader WCAG conformance gate
