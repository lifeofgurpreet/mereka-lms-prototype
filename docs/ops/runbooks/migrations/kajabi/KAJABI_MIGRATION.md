...
> Need to debug a broken lesson or mismatched structure? See `docs/ops/runbooks/migrations/kajabi/KAJABI_LESSON_CONTENT_FIX.md` and `docs/migrations/kajabi/KAJABI_LESSON_CONTENT_ISSUE.md` for known patterns and scripts.
