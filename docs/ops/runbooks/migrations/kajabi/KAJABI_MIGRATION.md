...
> Need to debug a broken lesson or mismatched structure? See `docs/reference/migrations/kajabi/KAJABI_LESSON_CONTENT_FIX.md` for the current repair patterns, API limitations, and fallback behavior.
