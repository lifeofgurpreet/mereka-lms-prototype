...
If AC-OVR-016 is active, use `reports/2026/closures/OBSERVABILITY_CLOSEOUT_QUEUE_2026-02-27.md` and execute `OBS-EXT-061` then `OBS-EXT-063` as the hard stop before other coverage runs.
