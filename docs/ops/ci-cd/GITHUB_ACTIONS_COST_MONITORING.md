...
(see `docs/ops/ci-cd/CI_OPTIMIZATION_TRACKER.md` Phase 5 tasks for the per-workflow migration checklist).
...
- **CI/CD Setup**: `docs/ops/ci-cd/CI_CD_SETUP.md` - GitHub Actions configuration
- **Release Checklist**: `docs/operations/RELEASE_CHECKLIST.md` - Deployment workflows
- **Cost Optimization Analysis**: `docs/ops/ci-cd/CI_PIPELINE_COST_OPTIMIZATION.md` - Expert review findings and phased plan
- **Optimization Tracker**: `docs/ops/ci-cd/CI_OPTIMIZATION_TRACKER.md` - Implementation tasks with file mappings
