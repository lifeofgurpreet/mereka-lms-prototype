...
Add to the security exceptions register (create at `docs/ops/security/SECURITY_EXCEPTIONS.md` if absent):
...
- `docs/operations/INCIDENT_TEMPLATES.md` — postmortem template
- `docs/ops/security/SECRET_ROTATION_CHECKLIST.md` — secret rotation procedure
- `docs/ops/security/SECRETS_SNAPSHOT.md` — current secret inventory
