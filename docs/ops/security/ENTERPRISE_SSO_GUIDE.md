...
- **SCIM bearer tokens** should be rotated annually per `docs/ops/security/SECRET_ROTATION_CHECKLIST.md`.
...
| `docs/ops/security/AUTH_HARDENING_SPEC.md` | Auth hardening decisions and implementation |
| `docs/ops/security/AUTH_AND_PERMISSIONS.md` | Permissions model documentation |
| `docs/concepts/architecture/RFC_CLAIM_BASED_ROLE_SYNC.md` | RFC for IdP claim → role mapping |
