...
| Slot | Operation | Component | File |
|------|-----------|-----------|------|
| `org.openedx.frontend.layout.header_logo.v1` | `Replace` | `MerekaHeaderLogo` | `mereka_lms.py` |
| `org.openedx.frontend.layout.footer.v1` | `Insert` + `Hide` default | `MerekaFooter` | `mereka_lms.py` |
| `org.openedx.frontend.authn.login_component.v1` | `Insert` | Brand injection | `mereka_lms.py` |
| Various learning/account/profile slots | `Insert` | Brand surfaces | `mereka_lms.py` |
