...
- **T107 — Design Tokens** (`docs/architecture/TOKEN_GENERATION_PIPELINE.md`): Canonical
...
| `docs/architecture/TOKEN_GENERATION_PIPELINE.md` | Token pipeline architecture (T107) |
