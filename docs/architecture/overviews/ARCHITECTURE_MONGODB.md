...
- `docs/runbooks/operations/COURSE_DATA_RECOVERY.md` (recovery/import flow, now reality-first)
- `docs/runbooks/operations/VELERO_BACKUP_AUDIT.md` (Velero posture, restore drill, and data-risk checks)
