...
> **Related**: `docs/architecture/overviews/FOOTER_PARITY.md`, `docs/guides/branding/BRANDING.md`
...
documented in `docs/architecture/overviews/FOOTER_PARITY.md` (WARN-001).
