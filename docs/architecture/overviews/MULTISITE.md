...
- **Change approvals**: Any domain, TLS, or theme change requires a release checklist sign-off (see `docs/runbooks/operations/RELEASE_CHECKLIST_DOMAIN_SECRETS.md`).
...
**Reference**:
- **Fast-Path Flow**: `docs/runbooks/operations/TENANT_PROVISIONING.md#fast-path-brand-pack-flow`
