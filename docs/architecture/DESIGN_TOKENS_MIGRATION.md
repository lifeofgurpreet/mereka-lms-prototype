...
- `docs/architecture/TOKEN_REFERENCE_INTEGRITY.md` — reference integrity rules
...
- `docs/architecture/TOKEN_GENERATION_PIPELINE.md` — pipeline contract and phase history
- `docs/architecture/TOKEN_REFERENCE_INTEGRITY.md` — reference integrity rules and token inventory
- `docs/architecture/WCAG_CONTRAST_POLICY_V2.md` — WCAG AA contrast compliance for token values
