...
**Full slot catalog**: `docs/architecture/MFE_PLUGIN_SLOT_INVENTORY.md` (100+ slots across 14 MFEs)
...
See `docs/branding/FOOTER_V2_TO_LMS_MAPPING.md` for the complete footer slot wiring example.
...
- **Slot Inventory**: `docs/architecture/MFE_PLUGIN_SLOT_INVENTORY.md` (100+ slots)
- **MFE Versions**: `docs/architecture/MFE_VERSIONS.md` (active MFEs)
- **Footer Mapping**: `docs/branding/FOOTER_V2_TO_LMS_MAPPING.md` (slot example)
- **Branding Contract**: `docs/branding/TENANT_BRANDING_CONTRACT.md`
