...
- See `docs/architecture/MFE_FOOTER_V2_DESIGN.md` for footer slot wiring
...
- **MFE Footer v2 Design**: `docs/architecture/MFE_FOOTER_V2_DESIGN.md` — Footer variant mapping
- **Tenant Branding Contract**: `docs/architecture/TENANT_BRANDING_CONTRACT.md` — Brand pack schema
- **Frontend Audit Checklist**: `docs/FRONTEND_AUDIT_CHECKLIST.md` — Copy/Terminology section
