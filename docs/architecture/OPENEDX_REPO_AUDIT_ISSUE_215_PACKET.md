...
- `docs/operations/evidence/router-smoke/prod-route-health-20260219-1214.md` contains raw `set-cookie` headers with `sessionid` and `csrftoken`.
...
4. Add policy doc:
   - `docs/operations/EVIDENCE_REDACTION_POLICY.md`
5. Cross-link docs:
...
2. Update docs:
   - `docs/operations/RELEASE_EVIDENCE.md`
   - `docs/operations/EVIDENCE_SCHEMA.md`
...
```bash
rg -n "set-cookie|authorization: bearer|sessionid=|csrftoken=" docs/operations/evidence docs/evidence/observability
...
```bash
rg -n "sessionid=|csrftoken=|authorization:\\s*bearer" docs/operations/evidence docs/evidence/observability
```
