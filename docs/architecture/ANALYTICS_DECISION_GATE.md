...
5. **Documentation**: Installation guide, quickstart, comparison docs in `docs/analytics/`
...
**Documentation**: See `docs/analytics/README.md` for current capabilities
...
- **Installation Guide**: [docs/analytics/ASPECTS_INSTALLATION.md](../analytics/ASPECTS_INSTALLATION.md)
- **Comparison**: [docs/analytics/ASPECTS_VS_PANORAMA.md](../analytics/ASPECTS_VS_PANORAMA.md)
- **Current Capabilities**: [docs/analytics/README.md](../analytics/README.md)
