...
Source tracker: `docs/architecture/OPENEDX_REPO_ARCH_HYGIENE_AUDIT_TRACKER.md`  
...
- `#215`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_215_PACKET.md`
- `#216`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_216_PACKET.md`
- `#217`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_217_PACKET.md`
- `#218`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_218_PACKET.md`
- `#219`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_219_PACKET.md`
- `#220`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_220_PACKET.md`
- `#221`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_221_PACKET.md`
- `#222`: `docs/architecture/OPENEDX_REPO_AUDIT_ISSUE_222_PACKET.md`
...
- `docs/operations/evidence/router-smoke/prod-route-health-20260219-1214.md` contains raw `set-cookie` with `sessionid` and `csrftoken`.
- Raw evidence is committed under `docs/operations/evidence/**` and `docs/evidence/observability/**`.
...
- `rg -n "set-cookie|sessionid=|csrftoken=|authorization:\\s*bearer" docs/operations/evidence docs/evidence/observability`
...
1. Add `docs/branding/THEMING_ARTIFACT_POLICY.md` with table:
   - source files
   - generated files
   - owner script
   - tracking policy.
