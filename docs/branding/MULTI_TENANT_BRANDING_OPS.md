...
**Related Documents**:
- `docs/branding/TENANT_BRANDING_CONTRACT.md` — Required inputs, fallback rules, brand pack schema
- `docs/branding/BRANDING_OPERATING_MODEL.md` — Canonical branding workflow
...
4. Resolution:
   ...
   - Post-resolution: document in incident log (docs/operations/evidence/)
...
Use `docs/branding/BRANDING_INCIDENT_TEMPLATE.md` to document any P1 or P2 branding regression. Complete the template fields before closing the incident.
