...
| Branding Operating Model | `docs/branding/BRANDING_OPERATING_MODEL.md` | Canonical branding workflow, non-negotiable rules |
| Tenant Branding Contract | `docs/branding/TENANT_BRANDING_CONTRACT.md` | Contract between tenant config and rendering layer |
| Brand Pack Schema | `docs/branding/TENANT_BRAND_PACK_SCHEMA.md` | Required fields for a tenant brand pack |
| Legacy Footer Removal | `docs/operations/LEGACY_FOOTER_REMOVAL.md` | Rollback steps for footer slot migration |
| Multisite Config | `docs/operations/MULTISITE.md` | Hostname routing and SITE_ID configuration |
...
`docs/operations/MULTISITE.md` and the Caddyfile template in
`infrastructure/tutor/apply-patches.sh`.
