...
- [`docs/runbooks/tenant-provisioning-runbook.md`](../runbooks/tenant-provisioning-runbook.md) — K8s provisioning runbook
...
- [ ] Evidence doc created in `docs/operations/evidence/` with all verify outputs
...
2. **P2 (branding wrong)**: Create `docs/branding/BRANDING_INCIDENT_TEMPLATE.md` entry → 4-hour SLA
3. **P3 (cosmetic)**: File GitHub issue → next sprint
4. **P4 (future enhancement)**: Add to `docs/branding/BRANDING_ROADMAP.md`
