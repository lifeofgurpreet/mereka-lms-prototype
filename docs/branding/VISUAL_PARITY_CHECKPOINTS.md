...
`docs/operations/VISUAL_REGRESSION_RUNBOOK.md` for ImageMagick command syntax.
...
- `docs/operations/VISUAL_REGRESSION_RUNBOOK.md` — ImageMagick commands, diff triage
- `docs/branding/BRANDING_OPERATING_MODEL.md` — Branding governance and release ops
- `docs/branding/BRANDING_GUARDRAILS.md` — CSS/SCSS guardrails
