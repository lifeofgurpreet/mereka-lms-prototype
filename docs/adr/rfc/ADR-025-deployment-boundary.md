...
**Related:** `docs/reference/architecture/RESOURCE_OWNERSHIP_MATRIX.md`, `scripts/qa/inventory_k8s_resources.sh`
...
See `docs/reference/architecture/RESOURCE_OWNERSHIP_MATRIX.md` for the full per-file classification table.
