...
**Related**: [Mobile Apps Secrets Management Spec](../../specs/proposals/proposals/proposals/mobile-apps-secrets-management_spec.md)
...
**Required secrets** (see `specs/proposals/proposals/proposals/mobile-apps-secrets-management_spec.md`):
```
