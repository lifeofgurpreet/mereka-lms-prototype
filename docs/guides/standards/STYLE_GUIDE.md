...
- **Quick start / Daily workflow:** `docs/guides/onboarding/`
- **Operations / Infra / Secrets:** `docs/operations/`
- **Migrations:** `docs/migrations/<domain>/`
- **Analytics / Reporting:** `docs/concepts/analytics/`
- **Integrations (OAuth, SSO, etc.):** `docs/guides/integrations/`
...
- Keep filenames scoped to their folder (e.g., `SETUP.md` inside `docs/guides/integrations/` is ambiguous—prefer `GOOGLE_OAUTH_SETUP.md`).
