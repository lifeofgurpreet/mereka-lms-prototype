...
_Audience: Docs Lead + Domain Owners • Owner: Platform Team • Last verified (UTC): 2026-03-07T02:25:11Z • Status: supporting_
...
- Command reference checks: pass (7 files, 0 missing)
- Command reference baseline coverage: enabled=true, entries=4
- Command reference source breakdown: inline=85, shell=33, md_link=1, md_autolink=1, md_refdef=0
- Link integrity checks: pass (3 files, 0 broken)
...
- foundation_policy_range=HEAD~1...HEAD, root_allowlist_violations=0, changed_markdown_files=3
