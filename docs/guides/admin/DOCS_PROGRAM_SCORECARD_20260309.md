...
_Audience: Docs Lead + Domain Owners • Owner: Platform Team • Last verified (UTC): 2026-03-09T05:00:22Z • Status: supporting_

## KPI Snapshot
- Total docs scope: 1430
- Canonical docs: 73
...
- Command reference checks: pass (475 files, 0 missing)
- Command reference baseline coverage: enabled=true, entries=4
- Command reference source breakdown: inline=784, shell=488, md_link=0, md_autolink=0, md_refdef=0
