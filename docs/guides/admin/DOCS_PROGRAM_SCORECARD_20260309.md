...
_Audience: Docs Lead + Domain Owners • Owner: Platform Team • Last verified (UTC): 2026-03-09T04:53:58Z • Status: supporting_
...
- Command reference checks: pass (42 files, 0 missing)
- Command reference baseline coverage: enabled=true, entries=4
- Command reference source breakdown: inline=96, shell=41, md_link=0, md_autolink=0, md_refdef=0
