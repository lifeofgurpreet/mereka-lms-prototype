...
_Audience: Docs Lead + Domain Owners • Owner: Platform Team • Last verified (UTC): 2026-03-09T07:01:03Z • Status: supporting_

## KPI Snapshot
- Total docs scope: 1434
- Canonical docs: 77
...
- Command reference checks: pass (10 files, 0 missing)
- Command reference baseline coverage: enabled=true, entries=4
- Command reference source breakdown: inline=48, shell=33, md_link=0, md_autolink=0, md_refdef=0
...
- foundation_policy_range=b529f1a381fb9e2299d040b19bd6fdda0ffee739...595eeecfbe71a0ad7b6d8037a24351f35efee8bc, root_allowlist_violations=0, changed_markdown_files=0
