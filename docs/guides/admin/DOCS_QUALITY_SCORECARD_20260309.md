...
- Last updated: `2026-03-09T05:00:22Z`
...
| `tools/docs/verify/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=475, candidates=1272, inline=784, shell=488, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
