...
- Branch: `docs/docs-wave2b-final-scorecard-refresh`
- Last updated: `2026-03-09T05:32:20Z`
...
| `tools/docs/verify/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=19, candidates=106, inline=67, shell=39, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
