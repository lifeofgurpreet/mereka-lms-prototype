...
- Branch: `docs/docs-wave4-audit`
- Last updated: `2026-03-09T02:25:58Z`
- Sync status: `origin/main` delta `3 6`
...
| `tools/docs/verify/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=9, candidates=169, inline=136, shell=33, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
