...
- Branch: `docs/docs-wave2b-final-scorecard-refresh-2`
- Last updated: `2026-03-09T05:41:43Z`
...
| `tools/docs/verify/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=4, candidates=77, inline=44, shell=33, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
