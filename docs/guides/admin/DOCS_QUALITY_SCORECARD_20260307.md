...
- Last updated: `2026-03-07T18:27:41Z`
- Sync status: `origin/main` delta `4 41`
...
| `docs/qa/verify-docs-policy.sh` | pass | foundation policy metrics | consistency_status=pass, consistency_detail=unknown, consistency_aligned=true, range=origin/main...HEAD, root_allowlist_violations=0, consistent=true, content_errors=0 |
...
| `docs/qa/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=140, candidates=1496, inline=1032, shell=464, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
| `docs/qa/verify-doc-link-integrity.sh` | unknown | link integrity summary | files=137, broken_links=0 |
