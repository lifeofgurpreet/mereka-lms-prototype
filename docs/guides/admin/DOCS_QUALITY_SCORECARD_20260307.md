...
- Last updated: `2026-03-07T02:23:37Z`
- Sync status: `origin/main` delta `0 70`
...
| `docs/qa/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=5, candidates=109, inline=74, shell=33, md_link=1, md_autolink=1, md_refdef=0, missing_refs=0 |
| `docs/qa/verify-doc-link-integrity.sh` | unknown | link integrity summary | files=1, broken_links=0 |
