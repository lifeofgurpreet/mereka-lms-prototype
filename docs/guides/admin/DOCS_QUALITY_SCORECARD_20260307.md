...
- Last updated: `2026-03-07T03:48:03Z`
- Sync status: `origin/main` delta `0 100`
...
| `docs/qa/verify-doc-command-refs.sh` | pass | command refs summary | docs command/path references, files=4, candidates=77, inline=44, shell=33, md_link=0, md_autolink=0, md_refdef=0, missing_refs=0 |
| `docs/qa/verify-doc-link-integrity.sh` | unknown | link integrity summary | files=0, broken_links=0 |
