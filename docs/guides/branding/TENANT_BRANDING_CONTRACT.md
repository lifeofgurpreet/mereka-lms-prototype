...
└── config.json                 # Tenant branding metadata (validated by specs/standards/brand-pack-schema.json — see scripts/qa/verify-brand-pack-schema.sh)
```
...
**Reference**: `docs/ops/runbooks/DOMAIN_MANAGEMENT.md`
