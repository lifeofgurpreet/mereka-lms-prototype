...
- To work with real Kajabi data locally, generate the CSVs/tarballs under `scripts/migrations/kajabi/output/` (see [`KAJABI_MIGRATION.md`](../../migrations/kajabi/KAJABI_MIGRATION.md)), then run the import helpers described in [`WORKFLOW_LOCAL.md`](WORKFLOW_LOCAL.md#5-data-imports-kajabi).
