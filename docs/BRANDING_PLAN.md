...
- Runtime evidence (`#105`):
  ...
  - Canonical blocker sweep lane added for repeated tracking:
    ...
    - latest diagnosis labels: `auth-surfaces:dev=credentials_dev_login_500`, `credentials-readiness:dev:cluster=credentials_timezone_tzdata_missing` (`var/qa/frontend-runtime-blocker-sweep-both-20260302T112446Z.diagnostics.tsv`).
