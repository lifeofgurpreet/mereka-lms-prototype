...
> **Verifier**: `tools/docs/verify/verify-docs-policy.sh`
...
See also:
- [`docs/policies/operations/FOOTER_SLOT_ONLY_POLICY.md`](FOOTER_SLOT_ONLY_POLICY.md) — Full exception register for footer non-slot paths (FTRE-001, FTRE-002)
- [`docs/reference/architecture/MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md`](MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md) — Full selector exception register (SEL-EXC-*)
...
1. File the patch requirement in `docs/runbooks/operations/BRANDING_RELEASE_RUNBOOK.md`
...
`docs/reference/architecture/MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md` is locked (LOCKED status as of Sprint S6, 2026-02-18). Any new entry requires:
...
|----|-------|--------|-------|
| AC-POST-001 | Closure doc exists | PASS | `reports/2026/closures/POSTMERGE_GOVERNANCE_CLOSURE.md` |
...
- [`docs/policies/operations/FOOTER_SLOT_ONLY_POLICY.md`](FOOTER_SLOT_ONLY_POLICY.md) — Footer slot-only policy + exception register (FTRE-001, FTRE-002)
- [`docs/reference/architecture/MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md`](MFE_PLUGIN_SLOT_MIGRATION_REGISTER.md) — Full selector exception register + migration roadmap
- [`docs/reference/operations/FOOTER_VARIANT_MATRIX.md`](FOOTER_VARIANT_MATRIX.md) — Per-domain footer configuration
- [`docs/reference/operations/MFE_ANALYTICS_PLUGIN_PARITY.md`](MFE_ANALYTICS_PLUGIN_PARITY.md) — Analytics plugin parity across MFEs
- `tools/docs/verify/verify-docs-policy.sh` — Repository docs-policy verifier used during closure checks
