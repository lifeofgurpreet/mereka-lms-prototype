...
| Check | Status | Evidence |
|-------|--------|----------|
| Token reference integrity contract documented | PASS | `docs/reference/architecture/TOKEN_REFERENCE_INTEGRITY.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Pipeline contract documented (AC-TKPIPE-001) | PASS | `docs/reference/architecture/TOKEN_GENERATION_PIPELINE.md` |
...
| Version tracking doc maintained | PASS | `docs/reference/architecture/MFE_VERSIONS.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Selector hardening policy documented | PASS | `docs/policies/architecture/SELECTOR_HARDENING_POLICY.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Interaction-state contract documented | PASS | docs/policies/architecture/INTERACTION_STATE_CONTRACT.md |
...
| Visual regression runbook | PASS | docs/runbooks/operations/VISUAL_REGRESSION_RUNBOOK.md |
...
| Plugin-slot inventory documented | PASS | `docs/reference/architecture/MFE_PLUGIN_SLOT_INVENTORY.md` — 100+ slots across 14 MFEs |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Migration contract documented (AC-FTSLOT-001) | PASS | `docs/runbooks/architecture/FOOTER_SLOT_MIGRATION.md` |
...
**Contract**: See `docs/runbooks/architecture/FOOTER_SLOT_MIGRATION.md` for full migration lifecycle
...
| Paragon alignment documented | PASS | `docs/guides/branding/PARAGON_TOKEN_ALIGNMENT.md` |
...
**Contract**: `docs/reference/architecture/MFE_ROUTE_TO_DIST_CONTRACT.md`
...
| Check | Status | Evidence |
|-------|--------|----------|
| Contrast policy v2 documented (AC-WCAG2-001) | PASS | `docs/policies/architecture/WCAG_CONTRAST_POLICY_V2.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Accessibility conformance policy documented | PASS | `docs/policies/architecture/ACCESSIBILITY_CONFORMANCE_POLICY.md` |
...
| Troubleshooting runbook documented (AC-TBR-105) | PASS | `docs/runbooks/operations/TENANT_BRANDING_TROUBLESHOOTING.md` |
...
**Troubleshooting**: See `docs/runbooks/operations/TENANT_BRANDING_TROUBLESHOOTING.md` for:
...
| Credentials documentation (AC-UIAUTH-004) | PASS | `docs/reference/operations/AUTHENTICATED_SMOKE_CREDENTIALS.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| MFE-first policy documented | PASS | `docs/policies/architecture/MFE_FIRST_POLICY.md` |
...
| Plugin slot inventory maintained | PASS | `docs/reference/architecture/MFE_PLUGIN_SLOT_INVENTORY.md` (100+ slots) |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Legacy ecommerce inventory documented | PASS | `docs/reference/operations/ECOMMERCE_DEPRECATION_INVENTORY.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Copy/terminology contract documented | PASS | `docs/policies/architecture/COPY_TERMINOLOGY_CONTRACT.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Performance budgets documented | PASS | `docs/policies/architecture/PERFORMANCE_BUDGETS.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Multisite UX contract documented | PASS | `docs/policies/architecture/MULTISITE_UX_CONSISTENCY.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Analytics drift guardrails documented (AC-ADRIFT-001) | PASS | `docs/policies/architecture/ANALYTICS_DRIFT_GUARDRAILS.md` |
...
| Superset deployment runbook exists (AC-SUPRT-001) | PASS | `docs/runbooks/architecture/SUPERSET_DEPLOYMENT_RUNBOOK.md` |
...
| Check | Status | Evidence |
|-------|--------|----------|
| Decision gate contract documented | PASS | `docs/policies/architecture/ANALYTICS_DECISION_GATE.md` |
