...
2. Document in `docs/runbooks/operations/TENANT_PROVISIONING.md` or create separate runbook.
...
| **8** | F-010 | Document zero-downtime brand-pack workflow | 4h | Low | Medium | F-007 (test with real tenant) | `docs/runbooks/operations/TENANT_PROVISIONING.md` |
...
- `docs/policies/architecture/MULTISITE_UX_CONSISTENCY.md` — Hardcoded domain audit findings
- `docs/status/readiness/TENANT_BRANDING_READINESS_RAG.md` — 5-dimension readiness assessment
- `docs/runbooks/operations/TENANT_BRANDING_TROUBLESHOOTING.md` — Known edge cases
...
### Runbooks & Guides
- `docs/runbooks/operations/TENANT_PROVISIONING.md` — Tenant provisioning workflow
- `docs/guides/branding/TENANT_BRANDING_CONTRACT.md` — Tenant branding contract
- `docs/architecture/overviews/multi-tenancy-overview.md` — Multi-tenancy architecture overview
