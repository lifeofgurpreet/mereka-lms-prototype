...
> - **UX consistency contract**: `docs/policies/architecture/MULTISITE_UX_CONSISTENCY.md`
> - **Site registry**: `infrastructure/tutor/multisite-sites.yml`
> - **Tenant branding matrix**: `docs/reference/operations/TENANT_BRANDING_SURFACE_MATRIX.md`
